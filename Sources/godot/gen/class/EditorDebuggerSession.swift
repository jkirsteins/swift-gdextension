...
public class EditorDebuggerSession : RefCounted {
    ...
    public override class func initialize_class() {
        ...
        self._method_send_message_3780025912 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_send_message_3780025912_name._native_ptr(), 3780025912)
        ...
        self._method_toggle_profiler_35674246 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_toggle_profiler_35674246_name._native_ptr(), 35674246)
        ...
        self._method_is_breaked_2240911060 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_is_breaked_2240911060_name._native_ptr(), 2240911060)
        ...
        self._method_is_debuggable_2240911060 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_is_debuggable_2240911060_name._native_ptr(), 2240911060)
        ...
        self._method_add_session_tab_1496901182 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_add_session_tab_1496901182_name._native_ptr(), 1496901182)
        ...
        self._method_remove_session_tab_1496901182 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_remove_session_tab_1496901182_name._native_ptr(), 1496901182)
    ...
    public func toggle_profiler(profiler: String, enable: UInt8, data: Array)  {
        withUnsafePointer(to: enable) { enable_native in
        withUnsafePointer(to: profiler) { profiler_native in
        let data_native = data._native_ptr()
