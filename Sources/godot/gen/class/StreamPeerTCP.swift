...
open class StreamPeerTCP : StreamPeer {
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        self._method_bind_4025329869 = self.interface.pointee.classdb_get_method_bind(__godot_name_StreamPeerTCP._native_ptr(), _method_bind_4025329869_name._native_ptr(), 4025329869)
        ...
        self._method_connect_to_host_993915709 = self.interface.pointee.classdb_get_method_bind(__godot_name_StreamPeerTCP._native_ptr(), _method_connect_to_host_993915709_name._native_ptr(), 993915709)
        assert(StreamPeerTCP._method_connect_to_host_993915709 != nil)
        let _method_poll_166280745_name = StringName(from: "poll")
        self._method_poll_166280745 = self.interface.pointee.classdb_get_method_bind(__godot_name_StreamPeerTCP._native_ptr(), _method_poll_166280745_name._native_ptr(), 166280745)
        assert(StreamPeerTCP._method_poll_166280745 != nil)
        let _method_get_status_859471121_name = StringName(from: "get_status")
        self._method_get_status_859471121 = self.interface.pointee.classdb_get_method_bind(__godot_name_StreamPeerTCP._native_ptr(), _method_get_status_859471121_name._native_ptr(), 859471121)
        ...
        self._method_get_connected_host_201670096 = self.interface.pointee.classdb_get_method_bind(__godot_name_StreamPeerTCP._native_ptr(), _method_get_connected_host_201670096_name._native_ptr(), 201670096)
        ...
        self._method_get_connected_port_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name_StreamPeerTCP._native_ptr(), _method_get_connected_port_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_get_local_port_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name_StreamPeerTCP._native_ptr(), _method_get_local_port_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_disconnect_from_host_3218959716 = self.interface.pointee.classdb_get_method_bind(__godot_name_StreamPeerTCP._native_ptr(), _method_disconnect_from_host_3218959716_name._native_ptr(), 3218959716)
        ...
        self._method_set_no_delay_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name_StreamPeerTCP._native_ptr(), _method_set_no_delay_2586408642_name._native_ptr(), 2586408642)
