...
/// 
/// MISSING
public class ZIPReader : RefCounted {
    ...
    public override class func initialize_class() {
        ...
        self._method_read_file_156385007 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_read_file_156385007_name._native_ptr(), 156385007)
        assert(ZIPReader._method_read_file_156385007 != nil)
    }

    public func open(path: String) -> Error {
    ...
    public func read_file(path: String, case_sensitive: UInt8) -> PackedByteArray {
