...
public class SpriteBase3D : GeometryInstance3D {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_axis_1144690656 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_axis_1144690656_name._native_ptr(), 1144690656)
        assert(SpriteBase3D._method_set_axis_1144690656 != nil)
        let _method_get_axis_3050976882_name = StringName(from: "get_axis")
        self._method_get_axis_3050976882 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_axis_3050976882_name._native_ptr(), 3050976882)
        ...
        self._method_set_draw_flag_1135633219 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_draw_flag_1135633219_name._native_ptr(), 1135633219)
        ...
        self._method_get_draw_flag_1733036628 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_draw_flag_1733036628_name._native_ptr(), 1733036628)
        ...
        self._method_set_alpha_cut_mode_227561226 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_alpha_cut_mode_227561226_name._native_ptr(), 227561226)
        ...
        self._method_get_alpha_cut_mode_336003791 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_alpha_cut_mode_336003791_name._native_ptr(), 336003791)
        ...
        self._method_get_item_rect_1639390495 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_item_rect_1639390495_name._native_ptr(), 1639390495)
    ...
    public func get_axis() -> Vector3.Axis {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return Vector3.Axis(from: __resPtr.pointee)
    }
    ...
    public func get_alpha_cut_mode() -> SpriteBase3D.AlphaCutMode {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return SpriteBase3D.AlphaCutMode(from: __resPtr.pointee)
    }
