...
public class VisualShaderNodeStep : VisualShaderNode {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_op_type_715172489 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_op_type_715172489_name._native_ptr(), 715172489)
        ...
        self._method_get_op_type_3274022781 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_op_type_3274022781_name._native_ptr(), 3274022781)
    ...
    public func get_op_type() -> VisualShaderNodeStep.OpType {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return VisualShaderNodeStep.OpType(from: __resPtr.pointee)
    }
}