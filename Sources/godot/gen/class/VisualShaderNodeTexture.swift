...
public class VisualShaderNodeTexture : VisualShaderNode {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_source_905262939 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_source_905262939_name._native_ptr(), 905262939)
        ...
        self._method_get_source_2896297444 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_source_2896297444_name._native_ptr(), 2896297444)
        ...
        self._method_set_texture_type_986314081 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_texture_type_986314081_name._native_ptr(), 986314081)
        ...
        self._method_get_texture_type_3290430153 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_texture_type_3290430153_name._native_ptr(), 3290430153)
    ...
    public func get_source() -> VisualShaderNodeTexture.Source {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return VisualShaderNodeTexture.Source(from: __resPtr.pointee)
    }
    ...
    public func get_texture_type() -> VisualShaderNodeTexture.TextureType {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return VisualShaderNodeTexture.TextureType(from: __resPtr.pointee)
    }
}