...
open class PacketPeer : RefCounted {
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        self._method_get_var_3442865206 = self.interface.pointee.classdb_get_method_bind(__godot_name_PacketPeer._native_ptr(), _method_get_var_3442865206_name._native_ptr(), 3442865206)
        assert(PacketPeer._method_get_var_3442865206 != nil)
        let _method_put_var_2436251611_name = StringName(from: "put_var")
        self._method_put_var_2436251611 = self.interface.pointee.classdb_get_method_bind(__godot_name_PacketPeer._native_ptr(), _method_put_var_2436251611_name._native_ptr(), 2436251611)
        assert(PacketPeer._method_put_var_2436251611 != nil)
        let _method_get_packet_2115431945_name = StringName(from: "get_packet")
        self._method_get_packet_2115431945 = self.interface.pointee.classdb_get_method_bind(__godot_name_PacketPeer._native_ptr(), _method_get_packet_2115431945_name._native_ptr(), 2115431945)
        assert(PacketPeer._method_get_packet_2115431945 != nil)
        let _method_put_packet_680677267_name = StringName(from: "put_packet")
        self._method_put_packet_680677267 = self.interface.pointee.classdb_get_method_bind(__godot_name_PacketPeer._native_ptr(), _method_put_packet_680677267_name._native_ptr(), 680677267)
        ...
        self._method_get_packet_error_3185525595 = self.interface.pointee.classdb_get_method_bind(__godot_name_PacketPeer._native_ptr(), _method_get_packet_error_3185525595_name._native_ptr(), 3185525595)
        ...
        self._method_get_available_packet_count_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name_PacketPeer._native_ptr(), _method_get_available_packet_count_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_get_encode_buffer_max_size_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name_PacketPeer._native_ptr(), _method_get_encode_buffer_max_size_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_set_encode_buffer_max_size_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name_PacketPeer._native_ptr(), _method_set_encode_buffer_max_size_1286410249_name._native_ptr(), 1286410249)
