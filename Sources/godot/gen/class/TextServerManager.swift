...
public class TextServerManager : Object {
    ...
    public override class func initialize_class() {
        ...
        self._method_add_interface_1799689403 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_add_interface_1799689403_name._native_ptr(), 1799689403)
        ...
        self._method_remove_interface_1799689403 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_remove_interface_1799689403_name._native_ptr(), 1799689403)
        ...
        self._method_get_interface_1672475555 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_interface_1672475555_name._native_ptr(), 1672475555)
        ...
        self._method_find_interface_2240905781 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_find_interface_2240905781_name._native_ptr(), 2240905781)
        ...
        self._method_set_primary_interface_1799689403 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_primary_interface_1799689403_name._native_ptr(), 1799689403)
        ...
        self._method_get_primary_interface_905850878 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_primary_interface_905850878_name._native_ptr(), 905850878)
    ...
    public func get_interface(idx: Int64) -> TextServer {
        ...
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            ...
            return TextServer(from: __resPtr.pointee)
        }
    }
    ...
    public func find_interface(name: String) -> TextServer {
