...
/// 
/// MISSING
public class CSGCylinder3D : CSGPrimitive3D {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_cone_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_cone_2586408642_name._native_ptr(), 2586408642)
        assert(CSGCylinder3D._method_set_cone_2586408642 != nil)
        let _method_is_cone_36873697_name = StringName(from: "is_cone")
        self._method_is_cone_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_is_cone_36873697_name._native_ptr(), 36873697)
