...
public class TileMapPattern : Resource {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_cell_634000503 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_cell_634000503_name._native_ptr(), 634000503)
        assert(TileMapPattern._method_set_cell_634000503 != nil)
        let _method_has_cell_3900751641_name = StringName(from: "has_cell")
        self._method_has_cell_3900751641 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_has_cell_3900751641_name._native_ptr(), 3900751641)
        assert(TileMapPattern._method_has_cell_3900751641 != nil)
        let _method_remove_cell_4153096796_name = StringName(from: "remove_cell")
        self._method_remove_cell_4153096796 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_remove_cell_4153096796_name._native_ptr(), 4153096796)
        ...
        self._method_get_cell_source_id_2485466453 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_cell_source_id_2485466453_name._native_ptr(), 2485466453)
        ...
        self._method_get_cell_atlas_coords_3050897911 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_cell_atlas_coords_3050897911_name._native_ptr(), 3050897911)
        ...
        self._method_get_cell_alternative_tile_2485466453 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_cell_alternative_tile_2485466453_name._native_ptr(), 2485466453)
