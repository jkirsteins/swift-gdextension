...
public class EditorUndoRedoManager : Object {
    ...
    public override class func initialize_class() {
        ...
        self._method_create_action_3766330317 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_create_action_3766330317_name._native_ptr(), 3766330317)
        ...
        self._method_add_do_method_1517810467 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_add_do_method_1517810467_name._native_ptr(), 1517810467)
        ...
        self._method_add_undo_method_1517810467 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_add_undo_method_1517810467_name._native_ptr(), 1517810467)
        ...
        self._method_get_object_history_id_1107568780 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_object_history_id_1107568780_name._native_ptr(), 1107568780)
        ...
        self._method_get_history_undo_redo_2417974513 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_history_undo_redo_2417974513_name._native_ptr(), 2417974513)
        assert(EditorUndoRedoManager._method_get_history_undo_redo_2417974513 != nil)
    }

    public func create_action(name: String, merge_mode: UndoRedo.MergeMode, custom_context: Object)  {
    ...
    public func get_history_undo_redo(id: Int64) -> UndoRedo {
        ...
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            ...
            return UndoRedo(from: __resPtr.pointee)
        }
    }
}