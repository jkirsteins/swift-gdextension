...
open class VisualShaderNodeColorParameter : VisualShaderNodeParameter {
    ...
    static var _method_set_default_value_2920490490: StringName! = nil
    static var _method_get_default_value_3444240500: StringName! = nil
    
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        
        guard p_level == GDEXTENSION_INITIALIZATION_SCENE else { return }

        assert(__godot_name_VisualShaderNodeColorParameter == nil)
        ...
        self._method_set_default_value_2920490490 = StringName(from: "set_default_value")
        assert(self._method_set_default_value_2920490490 != nil)
        self._method_get_default_value_3444240500 = StringName(from: "get_default_value")
        assert(self._method_get_default_value_3444240500 != nil)
    }
    ...
    public func set_default_value(value: Color)  {
        ...
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            ...
            let _mbinding = self.interface.pointee.classdb_get_method_bind(
                    Self.__godot_name._native_ptr(),
                    Self._method_set_default_value_2920490490._native_ptr(),
                    2920490490)
                assert(_mbinding != nil)
                self.interface.pointee.object_method_bind_ptrcall(
                    _mbinding,
    ...
    public func get_default_value() -> Color {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            let _mbinding = self.interface.pointee.classdb_get_method_bind(
                    Self.__godot_name._native_ptr(),
                    Self._method_get_default_value_3444240500._native_ptr(),
                    3444240500)
                assert(_mbinding != nil)
                self.interface.pointee.object_method_bind_ptrcall(
                    _mbinding,
