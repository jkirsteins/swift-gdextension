...
public class UndoRedo : Object {
    ...
    public override class func initialize_class() {
        ...
        self._method_create_action_183245820 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_create_action_183245820_name._native_ptr(), 183245820)
        ...
        self._method_commit_action_3216645846 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_commit_action_3216645846_name._native_ptr(), 3216645846)
        ...
        self._method_is_committing_action_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_is_committing_action_36873697_name._native_ptr(), 36873697)
        ...
        self._method_add_do_method_1611583062 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_add_do_method_1611583062_name._native_ptr(), 1611583062)
        ...
        self._method_add_undo_method_1611583062 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_add_undo_method_1611583062_name._native_ptr(), 1611583062)
        ...
        self._method_add_do_property_1017172818 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_add_do_property_1017172818_name._native_ptr(), 1017172818)
        ...
        self._method_add_undo_property_1017172818 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_add_undo_property_1017172818_name._native_ptr(), 1017172818)
        ...
        self._method_add_do_reference_3975164845 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_add_do_reference_3975164845_name._native_ptr(), 3975164845)
        ...
        self._method_add_undo_reference_3975164845 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_add_undo_reference_3975164845_name._native_ptr(), 3975164845)
        ...
        self._method_start_force_keep_in_merge_ends_3218959716 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_start_force_keep_in_merge_ends_3218959716_name._native_ptr(), 3218959716)
        ...
        self._method_end_force_keep_in_merge_ends_3218959716 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_end_force_keep_in_merge_ends_3218959716_name._native_ptr(), 3218959716)
        ...
        self._method_get_history_count_2455072627 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_history_count_2455072627_name._native_ptr(), 2455072627)
        ...
        self._method_get_current_action_2455072627 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_current_action_2455072627_name._native_ptr(), 2455072627)
        ...
        self._method_get_action_name_990163283 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_action_name_990163283_name._native_ptr(), 990163283)
        ...
        self._method_clear_history_3216645846 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_clear_history_3216645846_name._native_ptr(), 3216645846)
        ...
        self._method_get_current_action_name_201670096 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_current_action_name_201670096_name._native_ptr(), 201670096)
        ...
        self._method_redo_2240911060 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_redo_2240911060_name._native_ptr(), 2240911060)
        assert(UndoRedo._method_redo_2240911060 != nil)
        let _method_undo_2240911060_name = StringName(from: "undo")
        self._method_undo_2240911060 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_undo_2240911060_name._native_ptr(), 2240911060)
        assert(UndoRedo._method_undo_2240911060 != nil)
    }

    public func create_action(name: String, merge_mode: UndoRedo.MergeMode)  {
    ...
    public func get_action_name(id: Int64) -> String {
    ...
    public func get_current_action_name() -> String {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            defer { args.deallocate() }
            _ = args.initialize(from: [
