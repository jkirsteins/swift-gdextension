...
public class EditorScenePostImportPlugin : RefCounted {
    ...
    public override class func initialize_class() {
        ...
        self._method_get_option_value_2760726917 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_option_value_2760726917_name._native_ptr(), 2760726917)
        ...
        self._method_add_import_option_402577236 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_add_import_option_402577236_name._native_ptr(), 402577236)
        ...
        self._method_add_import_option_advanced_3774155785 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_add_import_option_advanced_3774155785_name._native_ptr(), 3774155785)
    ...
    public func _get_internal_option_visibility(category: Int64, for_animation: UInt8, option: String) -> Variant {
    ...
    public func _get_internal_option_update_view_required(category: Int64, option: String) -> Variant {
        withUnsafePointer(to: option) { option_native in
        withUnsafePointer(to: category) { category_native in
    ...
    public func add_import_option(name: String, value: Variant)  {
    ...
    public func add_import_option_advanced(`type`: Variant.`Typ`, name: String, default_value: Variant, hint: PropertyHint, hint_string: String, usage_flags: Int64)  {
