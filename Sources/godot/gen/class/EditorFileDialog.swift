...
public class EditorFileDialog : ConfirmationDialog {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_file_mode_274150415 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_file_mode_274150415_name._native_ptr(), 274150415)
        ...
        self._method_get_file_mode_2681044145 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_file_mode_2681044145_name._native_ptr(), 2681044145)
        ...
        self._method_set_access_3882893764 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_access_3882893764_name._native_ptr(), 3882893764)
        ...
        self._method_get_access_778734016 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_access_778734016_name._native_ptr(), 778734016)
        ...
        self._method_set_display_mode_3049004050 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_display_mode_3049004050_name._native_ptr(), 3049004050)
        ...
        self._method_get_display_mode_3517174669 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_display_mode_3517174669_name._native_ptr(), 3517174669)
        ...
        self._method_set_disable_overwrite_warning_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_disable_overwrite_warning_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_is_overwrite_warning_disabled_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_is_overwrite_warning_disabled_36873697_name._native_ptr(), 36873697)
    ...
    public func get_file_mode() -> EditorFileDialog.FileMode {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return EditorFileDialog.FileMode(from: __resPtr.pointee)
    }
    ...
    public func get_access() -> EditorFileDialog.Access {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return EditorFileDialog.Access(from: __resPtr.pointee)
    }
    ...
    public func get_display_mode() -> EditorFileDialog.DisplayMode {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return EditorFileDialog.DisplayMode(from: __resPtr.pointee)
    }
