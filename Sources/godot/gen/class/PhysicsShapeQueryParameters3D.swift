...
open class PhysicsShapeQueryParameters3D : RefCounted {
    ...
    static var _method_set_shape_968641751: StringName! = nil
    static var _method_get_shape_121922552: StringName! = nil
    static var _method_set_shape_rid_2722037293: StringName! = nil
    static var _method_get_shape_rid_2944877500: StringName! = nil
    static var _method_set_transform_2952846383: StringName! = nil
    static var _method_get_transform_3229777777: StringName! = nil
    static var _method_set_motion_3460891852: StringName! = nil
    static var _method_get_motion_3360562783: StringName! = nil
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        assert(__godot_name_PhysicsShapeQueryParameters3D == nil)
        __godot_name_PhysicsShapeQueryParameters3D = StringName(from: "PhysicsShapeQueryParameters3D")
        Self.interface = ginit.p_interface
        Self.library = ginit.p_library

        self._method_set_shape_968641751 = StringName(from: "set_shape")
        assert(self._method_set_shape_968641751 != nil)
        self._method_get_shape_121922552 = StringName(from: "get_shape")
        assert(self._method_get_shape_121922552 != nil)
        self._method_set_shape_rid_2722037293 = StringName(from: "set_shape_rid")
        assert(self._method_set_shape_rid_2722037293 != nil)
        self._method_get_shape_rid_2944877500 = StringName(from: "get_shape_rid")
        assert(self._method_get_shape_rid_2944877500 != nil)
        ...
        self._method_set_motion_3460891852 = StringName(from: "set_motion")
        assert(self._method_set_motion_3460891852 != nil)
        self._method_get_motion_3360562783 = StringName(from: "get_motion")
        assert(self._method_get_motion_3360562783 != nil)
    ...
    public func set_shape(shape: Resource)  {
        ...
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            ...
            let _mbinding = self.interface.pointee.classdb_get_method_bind(
                    ...
                    Self._method_set_shape_968641751._native_ptr(),
                    968641751)
    ...
    public func get_shape() -> Resource {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            let _mbinding = self.interface.pointee.classdb_get_method_bind(
                    Self.__godot_name._native_ptr(),
                    Self._method_get_shape_121922552._native_ptr(),
                    121922552)
                assert(_mbinding != nil)
                self.interface.pointee.object_method_bind_ptrcall(
                    _mbinding,
    ...
    public func set_shape_rid(shape: RID)  {
        ...
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            ...
            let _mbinding = self.interface.pointee.classdb_get_method_bind(
                    Self.__godot_name._native_ptr(),
                    Self._method_set_shape_rid_2722037293._native_ptr(),
                    2722037293)
                assert(_mbinding != nil)
                self.interface.pointee.object_method_bind_ptrcall(
                    _mbinding,
    ...
    public func get_shape_rid() -> RID {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            let _mbinding = self.interface.pointee.classdb_get_method_bind(
                    Self.__godot_name._native_ptr(),
                    Self._method_get_shape_rid_2944877500._native_ptr(),
                    2944877500)
                assert(_mbinding != nil)
                self.interface.pointee.object_method_bind_ptrcall(
                    _mbinding,
    ...
    public func set_motion(motion: Vector3)  {
        ...
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            ...
            let _mbinding = self.interface.pointee.classdb_get_method_bind(
                    Self.__godot_name._native_ptr(),
                    Self._method_set_motion_3460891852._native_ptr(),
                    3460891852)
                assert(_mbinding != nil)
                self.interface.pointee.object_method_bind_ptrcall(
                    _mbinding,
    ...
    public func get_motion() -> Vector3 {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            let _mbinding = self.interface.pointee.classdb_get_method_bind(
                    Self.__godot_name._native_ptr(),
                    Self._method_get_motion_3360562783._native_ptr(),
                    3360562783)
                assert(_mbinding != nil)
                self.interface.pointee.object_method_bind_ptrcall(
                    _mbinding,
