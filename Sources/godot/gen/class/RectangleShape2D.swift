...
open class RectangleShape2D : Shape2D {
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        self._method_set_size_743155724 = self.interface.pointee.classdb_get_method_bind(__godot_name_RectangleShape2D._native_ptr(), _method_set_size_743155724_name._native_ptr(), 743155724)
        assert(RectangleShape2D._method_set_size_743155724 != nil)
        let _method_get_size_3341600327_name = StringName(from: "get_size")
        self._method_get_size_3341600327 = self.interface.pointee.classdb_get_method_bind(__godot_name_RectangleShape2D._native_ptr(), _method_get_size_3341600327_name._native_ptr(), 3341600327)
