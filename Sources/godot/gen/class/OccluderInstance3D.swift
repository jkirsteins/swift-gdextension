...
open class OccluderInstance3D : Node3D {
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        self._method_set_bake_mask_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name_OccluderInstance3D._native_ptr(), _method_set_bake_mask_1286410249_name._native_ptr(), 1286410249)
        ...
        self._method_get_bake_mask_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name_OccluderInstance3D._native_ptr(), _method_get_bake_mask_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_set_bake_mask_value_300928843 = self.interface.pointee.classdb_get_method_bind(__godot_name_OccluderInstance3D._native_ptr(), _method_set_bake_mask_value_300928843_name._native_ptr(), 300928843)
        ...
        self._method_get_bake_mask_value_1116898809 = self.interface.pointee.classdb_get_method_bind(__godot_name_OccluderInstance3D._native_ptr(), _method_get_bake_mask_value_1116898809_name._native_ptr(), 1116898809)
        ...
        self._method_set_bake_simplification_distance_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name_OccluderInstance3D._native_ptr(), _method_set_bake_simplification_distance_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_bake_simplification_distance_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name_OccluderInstance3D._native_ptr(), _method_get_bake_simplification_distance_1740695150_name._native_ptr(), 1740695150)
        ...
        self._method_set_occluder_1664878165 = self.interface.pointee.classdb_get_method_bind(__godot_name_OccluderInstance3D._native_ptr(), _method_set_occluder_1664878165_name._native_ptr(), 1664878165)
        ...
        self._method_get_occluder_1696836198 = self.interface.pointee.classdb_get_method_bind(__godot_name_OccluderInstance3D._native_ptr(), _method_get_occluder_1696836198_name._native_ptr(), 1696836198)
