...
public class SkeletonModificationStack2D : Resource {
    ...
    public override class func initialize_class() {
        ...
        self._method_setup_3218959716 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_setup_3218959716_name._native_ptr(), 3218959716)
        ...
        self._method_execute_1005356550 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_execute_1005356550_name._native_ptr(), 1005356550)
        ...
        self._method_enable_all_modifications_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_enable_all_modifications_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_get_modification_2570274329 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_modification_2570274329_name._native_ptr(), 2570274329)
        ...
        self._method_add_modification_354162120 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_add_modification_354162120_name._native_ptr(), 354162120)
        ...
        self._method_delete_modification_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_delete_modification_1286410249_name._native_ptr(), 1286410249)
        ...
        self._method_set_modification_1098262544 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_modification_1098262544_name._native_ptr(), 1098262544)
        ...
        self._method_set_modification_count_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_modification_count_1286410249_name._native_ptr(), 1286410249)
        ...
        self._method_get_modification_count_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_modification_count_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_get_enabled_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_enabled_36873697_name._native_ptr(), 36873697)
        ...
        self._method_get_skeleton_1697361217 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_skeleton_1697361217_name._native_ptr(), 1697361217)
    ...
    public func get_modification(mod_idx: Int64) -> SkeletonModification2D {
        ...
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            ...
            return SkeletonModification2D(from: __resPtr.pointee)
        }
    }
    ...
    public func get_skeleton() -> Skeleton2D {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return Skeleton2D(from: __resPtr.pointee)
    }
}