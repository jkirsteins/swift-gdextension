...
public class VisualShaderNodeUVFunc : VisualShaderNode {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_function_765791915 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_function_765791915_name._native_ptr(), 765791915)
        ...
        self._method_get_function_3772902164 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_function_3772902164_name._native_ptr(), 3772902164)
    ...
    public func get_function() -> VisualShaderNodeUVFunc.Function {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return VisualShaderNodeUVFunc.Function(from: __resPtr.pointee)
    }
}