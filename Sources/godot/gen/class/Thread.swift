...
public class Thread : RefCounted {
    ...
    public override class func initialize_class() {
        ...
        self._method_start_2779832528 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_start_2779832528_name._native_ptr(), 2779832528)
        assert(Thread._method_start_2779832528 != nil)
        let _method_get_id_201670096_name = StringName(from: "get_id")
        self._method_get_id_201670096 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_id_201670096_name._native_ptr(), 201670096)
        assert(Thread._method_get_id_201670096 != nil)
        let _method_is_started_36873697_name = StringName(from: "is_started")
        self._method_is_started_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_is_started_36873697_name._native_ptr(), 36873697)
        assert(Thread._method_is_started_36873697 != nil)
        let _method_is_alive_36873697_name = StringName(from: "is_alive")
        self._method_is_alive_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_is_alive_36873697_name._native_ptr(), 36873697)
        assert(Thread._method_is_alive_36873697 != nil)
        let _method_wait_to_finish_1460262497_name = StringName(from: "wait_to_finish")
        self._method_wait_to_finish_1460262497 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_wait_to_finish_1460262497_name._native_ptr(), 1460262497)
