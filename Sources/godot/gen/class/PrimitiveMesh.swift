...
open class PrimitiveMesh : Mesh {
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        self._method_set_material_2757459619 = self.interface.pointee.classdb_get_method_bind(__godot_name_PrimitiveMesh._native_ptr(), _method_set_material_2757459619_name._native_ptr(), 2757459619)
        ...
        self._method_get_material_5934680 = self.interface.pointee.classdb_get_method_bind(__godot_name_PrimitiveMesh._native_ptr(), _method_get_material_5934680_name._native_ptr(), 5934680)
        ...
        self._method_get_mesh_arrays_3995934104 = self.interface.pointee.classdb_get_method_bind(__godot_name_PrimitiveMesh._native_ptr(), _method_get_mesh_arrays_3995934104_name._native_ptr(), 3995934104)
        ...
        self._method_set_custom_aabb_259215842 = self.interface.pointee.classdb_get_method_bind(__godot_name_PrimitiveMesh._native_ptr(), _method_set_custom_aabb_259215842_name._native_ptr(), 259215842)
        ...
        self._method_get_custom_aabb_1068685055 = self.interface.pointee.classdb_get_method_bind(__godot_name_PrimitiveMesh._native_ptr(), _method_get_custom_aabb_1068685055_name._native_ptr(), 1068685055)
        ...
        self._method_set_flip_faces_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name_PrimitiveMesh._native_ptr(), _method_set_flip_faces_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_get_flip_faces_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name_PrimitiveMesh._native_ptr(), _method_get_flip_faces_36873697_name._native_ptr(), 36873697)
        ...
        self._method_set_add_uv2_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name_PrimitiveMesh._native_ptr(), _method_set_add_uv2_2586408642_name._native_ptr(), 2586408642)
        assert(PrimitiveMesh._method_set_add_uv2_2586408642 != nil)
        let _method_get_add_uv2_36873697_name = StringName(from: "get_add_uv2")
        self._method_get_add_uv2_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name_PrimitiveMesh._native_ptr(), _method_get_add_uv2_36873697_name._native_ptr(), 36873697)
        ...
        self._method_set_uv2_padding_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name_PrimitiveMesh._native_ptr(), _method_set_uv2_padding_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_uv2_padding_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name_PrimitiveMesh._native_ptr(), _method_get_uv2_padding_1740695150_name._native_ptr(), 1740695150)
