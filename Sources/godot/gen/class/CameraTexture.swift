...
public class CameraTexture : Texture2D {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_which_feed_1595299230 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_which_feed_1595299230_name._native_ptr(), 1595299230)
        ...
        self._method_get_which_feed_91039457 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_which_feed_91039457_name._native_ptr(), 91039457)
        ...
        self._method_set_camera_active_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_camera_active_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_get_camera_active_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_camera_active_36873697_name._native_ptr(), 36873697)
    ...
    public func get_which_feed() -> CameraServer.FeedImage {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return CameraServer.FeedImage(from: __resPtr.pointee)
    }
