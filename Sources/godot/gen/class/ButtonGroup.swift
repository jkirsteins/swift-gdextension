...
public class ButtonGroup : Resource {
    ...
    public override class func initialize_class() {
        ...
        self._method_get_pressed_button_3886434893 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_pressed_button_3886434893_name._native_ptr(), 3886434893)
        ...
        self._method_get_buttons_2915620761 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_buttons_2915620761_name._native_ptr(), 2915620761)
    ...
    public func get_pressed_button() -> BaseButton {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return BaseButton(from: __resPtr.pointee)
    }
