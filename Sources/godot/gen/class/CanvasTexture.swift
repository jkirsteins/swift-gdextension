...
public class CanvasTexture : Texture2D {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_diffuse_texture_4051416890 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_diffuse_texture_4051416890_name._native_ptr(), 4051416890)
        ...
        self._method_get_diffuse_texture_3635182373 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_diffuse_texture_3635182373_name._native_ptr(), 3635182373)
        ...
        self._method_set_normal_texture_4051416890 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_normal_texture_4051416890_name._native_ptr(), 4051416890)
        ...
        self._method_get_normal_texture_3635182373 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_normal_texture_3635182373_name._native_ptr(), 3635182373)
        ...
        self._method_set_specular_texture_4051416890 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_specular_texture_4051416890_name._native_ptr(), 4051416890)
        ...
        self._method_get_specular_texture_3635182373 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_specular_texture_3635182373_name._native_ptr(), 3635182373)
        ...
        self._method_set_specular_color_2920490490 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_specular_color_2920490490_name._native_ptr(), 2920490490)
        ...
        self._method_get_specular_color_3444240500 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_specular_color_3444240500_name._native_ptr(), 3444240500)
        ...
        self._method_set_specular_shininess_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_specular_shininess_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_specular_shininess_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_specular_shininess_1740695150_name._native_ptr(), 1740695150)
    ...
    public func get_texture_filter() -> CanvasItem.TextureFilter {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return CanvasItem.TextureFilter(from: __resPtr.pointee)
    }
    ...
    public func get_texture_repeat() -> CanvasItem.TextureRepeat {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return CanvasItem.TextureRepeat(from: __resPtr.pointee)
    }
}