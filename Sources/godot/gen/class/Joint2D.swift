...
open class Joint2D : Node2D {
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        self._method_set_node_a_1348162250 = self.interface.pointee.classdb_get_method_bind(__godot_name_Joint2D._native_ptr(), _method_set_node_a_1348162250_name._native_ptr(), 1348162250)
        assert(Joint2D._method_set_node_a_1348162250 != nil)
        let _method_get_node_a_4075236667_name = StringName(from: "get_node_a")
        self._method_get_node_a_4075236667 = self.interface.pointee.classdb_get_method_bind(__godot_name_Joint2D._native_ptr(), _method_get_node_a_4075236667_name._native_ptr(), 4075236667)
        assert(Joint2D._method_get_node_a_4075236667 != nil)
        let _method_set_node_b_1348162250_name = StringName(from: "set_node_b")
        self._method_set_node_b_1348162250 = self.interface.pointee.classdb_get_method_bind(__godot_name_Joint2D._native_ptr(), _method_set_node_b_1348162250_name._native_ptr(), 1348162250)
        assert(Joint2D._method_set_node_b_1348162250 != nil)
        let _method_get_node_b_4075236667_name = StringName(from: "get_node_b")
        self._method_get_node_b_4075236667 = self.interface.pointee.classdb_get_method_bind(__godot_name_Joint2D._native_ptr(), _method_get_node_b_4075236667_name._native_ptr(), 4075236667)
        assert(Joint2D._method_get_node_b_4075236667 != nil)
        let _method_set_bias_373806689_name = StringName(from: "set_bias")
        self._method_set_bias_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name_Joint2D._native_ptr(), _method_set_bias_373806689_name._native_ptr(), 373806689)
        assert(Joint2D._method_set_bias_373806689 != nil)
        let _method_get_bias_1740695150_name = StringName(from: "get_bias")
        self._method_get_bias_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name_Joint2D._native_ptr(), _method_get_bias_1740695150_name._native_ptr(), 1740695150)
        ...
        self._method_set_exclude_nodes_from_collision_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name_Joint2D._native_ptr(), _method_set_exclude_nodes_from_collision_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_get_exclude_nodes_from_collision_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name_Joint2D._native_ptr(), _method_get_exclude_nodes_from_collision_36873697_name._native_ptr(), 36873697)
