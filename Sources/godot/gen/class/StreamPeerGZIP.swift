...
public class StreamPeerGZIP : StreamPeer {
    ...
    public override class func initialize_class() {
        ...
        self._method_start_compression_781582770 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_start_compression_781582770_name._native_ptr(), 781582770)
        ...
        self._method_start_decompression_781582770 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_start_decompression_781582770_name._native_ptr(), 781582770)
        assert(StreamPeerGZIP._method_start_decompression_781582770 != nil)
        let _method_finish_166280745_name = StringName(from: "finish")
        self._method_finish_166280745 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_finish_166280745_name._native_ptr(), 166280745)
