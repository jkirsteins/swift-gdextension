...
public class CollisionObject2D : Node2D {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_disable_mode_1919204045 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_disable_mode_1919204045_name._native_ptr(), 1919204045)
        ...
        self._method_get_disable_mode_3172846349 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_disable_mode_3172846349_name._native_ptr(), 3172846349)
        ...
        self._method_set_pickable_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_pickable_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_is_pickable_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_is_pickable_36873697_name._native_ptr(), 36873697)
        ...
        self._method_shape_owner_set_transform_30160968 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_shape_owner_set_transform_30160968_name._native_ptr(), 30160968)
        ...
        self._method_shape_owner_get_transform_3836996910 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_shape_owner_get_transform_3836996910_name._native_ptr(), 3836996910)
        ...
        self._method_shape_owner_set_one_way_collision_300928843 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_shape_owner_set_one_way_collision_300928843_name._native_ptr(), 300928843)
        ...
        self._method_is_shape_owner_one_way_collision_enabled_1116898809 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_is_shape_owner_one_way_collision_enabled_1116898809_name._native_ptr(), 1116898809)
        ...
        self._method_shape_owner_set_one_way_collision_margin_1602489585 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_shape_owner_set_one_way_collision_margin_1602489585_name._native_ptr(), 1602489585)
        ...
        self._method_get_shape_owner_one_way_collision_margin_2339986948 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_shape_owner_one_way_collision_margin_2339986948_name._native_ptr(), 2339986948)
        ...
        self._method_shape_owner_add_shape_2077425081 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_shape_owner_add_shape_2077425081_name._native_ptr(), 2077425081)
        ...
        self._method_shape_owner_get_shape_3106725749 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_shape_owner_get_shape_3106725749_name._native_ptr(), 3106725749)
    ...
    public func get_disable_mode() -> CollisionObject2D.DisableMode {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return CollisionObject2D.DisableMode(from: __resPtr.pointee)
    }
