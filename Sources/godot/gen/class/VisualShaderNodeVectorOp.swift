...
public class VisualShaderNodeVectorOp : VisualShaderNodeVectorBase {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_operator_3371507302 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_operator_3371507302_name._native_ptr(), 3371507302)
        ...
        self._method_get_operator_11793929 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_operator_11793929_name._native_ptr(), 11793929)
    ...
    public func get_operator() -> VisualShaderNodeVectorOp.Operator {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return VisualShaderNodeVectorOp.Operator(from: __resPtr.pointee)
    }
}