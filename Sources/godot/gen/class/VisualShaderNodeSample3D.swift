...
public class VisualShaderNodeSample3D : VisualShaderNode {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_source_3315130991 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_source_3315130991_name._native_ptr(), 3315130991)
        ...
        self._method_get_source_1079494121 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_source_1079494121_name._native_ptr(), 1079494121)
    ...
    public func get_source() -> VisualShaderNodeSample3D.Source {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return VisualShaderNodeSample3D.Source(from: __resPtr.pointee)
    }
}