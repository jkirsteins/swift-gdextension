...
public class VisualShaderNodeTransformFunc : VisualShaderNode {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_function_2900990409 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_function_2900990409_name._native_ptr(), 2900990409)
        ...
        self._method_get_function_2839926569 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_function_2839926569_name._native_ptr(), 2839926569)
    ...
    public func get_function() -> VisualShaderNodeTransformFunc.Function {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return VisualShaderNodeTransformFunc.Function(from: __resPtr.pointee)
    }
}