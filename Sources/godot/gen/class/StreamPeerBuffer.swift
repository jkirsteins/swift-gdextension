...
public class StreamPeerBuffer : StreamPeer {
    ...
    public override class func initialize_class() {
        ...
        self._method_get_size_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_size_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_resize_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_resize_1286410249_name._native_ptr(), 1286410249)
        ...
        self._method_set_data_array_2971499966 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_data_array_2971499966_name._native_ptr(), 2971499966)
        ...
        self._method_get_data_array_2362200018 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_data_array_2362200018_name._native_ptr(), 2362200018)
        ...
        self._method_duplicate_2474064677 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_duplicate_2474064677_name._native_ptr(), 2474064677)
    ...
    public func duplicate() -> StreamPeerBuffer {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return StreamPeerBuffer(from: __resPtr.pointee)
    }
}