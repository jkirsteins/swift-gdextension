...
open class NavigationPathQueryResult3D : RefCounted {
    ...
    static var _method_set_path_334873810: StringName! = nil
    static var _method_get_path_497664490: StringName! = nil
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        assert(__godot_name_NavigationPathQueryResult3D == nil)
        __godot_name_NavigationPathQueryResult3D = StringName(from: "NavigationPathQueryResult3D")
        Self.interface = ginit.p_interface
        Self.library = ginit.p_library

        self._method_set_path_334873810 = StringName(from: "set_path")
        assert(self._method_set_path_334873810 != nil)
        self._method_get_path_497664490 = StringName(from: "get_path")
        assert(self._method_get_path_497664490 != nil)
    ...
    public func set_path(path: PackedVector3Array)  {
        ...
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            ...
            let _mbinding = self.interface.pointee.classdb_get_method_bind(
                    ...
                    Self._method_set_path_334873810._native_ptr(),
                    334873810)
    ...
    public func get_path() -> PackedVector3Array {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            let _mbinding = self.interface.pointee.classdb_get_method_bind(
                    Self.__godot_name._native_ptr(),
                    Self._method_get_path_497664490._native_ptr(),
                    497664490)
                assert(_mbinding != nil)
                self.interface.pointee.object_method_bind_ptrcall(
                    _mbinding,
