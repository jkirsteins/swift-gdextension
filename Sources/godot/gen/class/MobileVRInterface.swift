...
/// 
/// MISSING
public class MobileVRInterface : XRInterface {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_eye_height_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_eye_height_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_eye_height_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_eye_height_1740695150_name._native_ptr(), 1740695150)
        assert(MobileVRInterface._method_get_eye_height_1740695150 != nil)
        let _method_set_iod_373806689_name = StringName(from: "set_iod")
        self._method_set_iod_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_iod_373806689_name._native_ptr(), 373806689)
        assert(MobileVRInterface._method_set_iod_373806689 != nil)
        let _method_get_iod_1740695150_name = StringName(from: "get_iod")
        self._method_get_iod_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_iod_1740695150_name._native_ptr(), 1740695150)
        ...
        self._method_set_display_width_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_display_width_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_display_width_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_display_width_1740695150_name._native_ptr(), 1740695150)
        ...
        self._method_set_display_to_lens_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_display_to_lens_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_display_to_lens_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_display_to_lens_1740695150_name._native_ptr(), 1740695150)
        ...
        self._method_set_oversample_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_oversample_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_oversample_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_oversample_1740695150_name._native_ptr(), 1740695150)
        assert(MobileVRInterface._method_get_oversample_1740695150 != nil)
        let _method_set_k1_373806689_name = StringName(from: "set_k1")
        self._method_set_k1_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_k1_373806689_name._native_ptr(), 373806689)
        assert(MobileVRInterface._method_set_k1_373806689 != nil)
        let _method_get_k1_1740695150_name = StringName(from: "get_k1")
        self._method_get_k1_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_k1_1740695150_name._native_ptr(), 1740695150)
        assert(MobileVRInterface._method_get_k1_1740695150 != nil)
        let _method_set_k2_373806689_name = StringName(from: "set_k2")
        self._method_set_k2_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_k2_373806689_name._native_ptr(), 373806689)
        assert(MobileVRInterface._method_set_k2_373806689 != nil)
        let _method_get_k2_1740695150_name = StringName(from: "get_k2")
        self._method_get_k2_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_k2_1740695150_name._native_ptr(), 1740695150)
