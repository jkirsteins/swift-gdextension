...
open class RegExMatch : RefCounted {
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        self._method_get_subject_201670096 = self.interface.pointee.classdb_get_method_bind(__godot_name_RegExMatch._native_ptr(), _method_get_subject_201670096_name._native_ptr(), 201670096)
        ...
        self._method_get_group_count_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name_RegExMatch._native_ptr(), _method_get_group_count_3905245786_name._native_ptr(), 3905245786)
        assert(RegExMatch._method_get_group_count_3905245786 != nil)
        let _method_get_names_3102165223_name = StringName(from: "get_names")
        self._method_get_names_3102165223 = self.interface.pointee.classdb_get_method_bind(__godot_name_RegExMatch._native_ptr(), _method_get_names_3102165223_name._native_ptr(), 3102165223)
        assert(RegExMatch._method_get_names_3102165223 != nil)
        let _method_get_strings_1139954409_name = StringName(from: "get_strings")
        self._method_get_strings_1139954409 = self.interface.pointee.classdb_get_method_bind(__godot_name_RegExMatch._native_ptr(), _method_get_strings_1139954409_name._native_ptr(), 1139954409)
        assert(RegExMatch._method_get_strings_1139954409 != nil)
        let _method_get_string_687115856_name = StringName(from: "get_string")
        self._method_get_string_687115856 = self.interface.pointee.classdb_get_method_bind(__godot_name_RegExMatch._native_ptr(), _method_get_string_687115856_name._native_ptr(), 687115856)
        assert(RegExMatch._method_get_string_687115856 != nil)
        let _method_get_start_490464691_name = StringName(from: "get_start")
        self._method_get_start_490464691 = self.interface.pointee.classdb_get_method_bind(__godot_name_RegExMatch._native_ptr(), _method_get_start_490464691_name._native_ptr(), 490464691)
        assert(RegExMatch._method_get_start_490464691 != nil)
        let _method_get_end_490464691_name = StringName(from: "get_end")
        self._method_get_end_490464691 = self.interface.pointee.classdb_get_method_bind(__godot_name_RegExMatch._native_ptr(), _method_get_end_490464691_name._native_ptr(), 490464691)
        assert(RegExMatch._method_get_end_490464691 != nil)
    }

    public func get_subject() -> godot.String {
    ...
    public func get_string(name: Variant) -> godot.String {
