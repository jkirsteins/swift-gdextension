...
public class PathFollow2D : Node2D {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_rotates_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_rotates_2586408642_name._native_ptr(), 2586408642)
        assert(PathFollow2D._method_set_rotates_2586408642 != nil)
        let _method_is_rotating_36873697_name = StringName(from: "is_rotating")
        self._method_is_rotating_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_is_rotating_36873697_name._native_ptr(), 36873697)
        ...
        self._method_set_lookahead_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_lookahead_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_lookahead_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_lookahead_1740695150_name._native_ptr(), 1740695150)
