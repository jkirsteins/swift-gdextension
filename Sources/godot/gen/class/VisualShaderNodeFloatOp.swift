...
public class VisualShaderNodeFloatOp : VisualShaderNode {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_operator_2488468047 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_operator_2488468047_name._native_ptr(), 2488468047)
        ...
        self._method_get_operator_1867979390 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_operator_1867979390_name._native_ptr(), 1867979390)
    ...
    public func get_operator() -> VisualShaderNodeFloatOp.Operator {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return VisualShaderNodeFloatOp.Operator(from: __resPtr.pointee)
    }
}