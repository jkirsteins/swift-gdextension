...
public class CanvasItem : Node {
    ...
    public func draw_string(font: Font, pos: Vector2, text: String, alignment: HorizontalAlignment, width: Float64, font_size: Int64, modulate: Color, jst_flags: TextServer.JustificationFlag, direction: TextServer.Direction, orientation: TextServer.Orientation)  {
    ...
    public func draw_multiline_string(font: Font, pos: Vector2, text: String, alignment: HorizontalAlignment, width: Float64, font_size: Int64, max_lines: Int64, modulate: Color, brk_flags: TextServer.LineBreakFlag, jst_flags: TextServer.JustificationFlag, direction: TextServer.Direction, orientation: TextServer.Orientation)  {
    ...
    public func draw_string_outline(font: Font, pos: Vector2, text: String, alignment: HorizontalAlignment, width: Float64, font_size: Int64, size: Int64, modulate: Color, jst_flags: TextServer.JustificationFlag, direction: TextServer.Direction, orientation: TextServer.Orientation)  {
    ...
    public func get_clip_children_mode() -> CanvasItem.ClipChildrenMode {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return CanvasItem.ClipChildrenMode(from: __resPtr.pointee)
    }
}