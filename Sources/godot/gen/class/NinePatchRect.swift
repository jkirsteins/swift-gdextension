...
public class NinePatchRect : Control {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_patch_margin_437707142 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_patch_margin_437707142_name._native_ptr(), 437707142)
        ...
        self._method_get_patch_margin_1983885014 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_patch_margin_1983885014_name._native_ptr(), 1983885014)
        ...
        self._method_set_h_axis_stretch_mode_3219608417 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_h_axis_stretch_mode_3219608417_name._native_ptr(), 3219608417)
        ...
        self._method_get_h_axis_stretch_mode_3317113799 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_h_axis_stretch_mode_3317113799_name._native_ptr(), 3317113799)
        ...
        self._method_set_v_axis_stretch_mode_3219608417 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_v_axis_stretch_mode_3219608417_name._native_ptr(), 3219608417)
        ...
        self._method_get_v_axis_stretch_mode_3317113799 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_v_axis_stretch_mode_3317113799_name._native_ptr(), 3317113799)
    ...
    public func get_h_axis_stretch_mode() -> NinePatchRect.AxisStretchMode {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return NinePatchRect.AxisStretchMode(from: __resPtr.pointee)
    }
