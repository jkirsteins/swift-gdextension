...
public class AudioEffectDistortion : AudioEffect {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_mode_1314744793 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_mode_1314744793_name._native_ptr(), 1314744793)
        assert(AudioEffectDistortion._method_set_mode_1314744793 != nil)
        let _method_get_mode_809118343_name = StringName(from: "get_mode")
        self._method_get_mode_809118343 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_mode_809118343_name._native_ptr(), 809118343)
        ...
        self._method_set_pre_gain_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_pre_gain_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_pre_gain_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_pre_gain_1740695150_name._native_ptr(), 1740695150)
        ...
        self._method_set_keep_hf_hz_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_keep_hf_hz_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_keep_hf_hz_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_keep_hf_hz_1740695150_name._native_ptr(), 1740695150)
        ...
        self._method_set_drive_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_drive_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_drive_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_drive_1740695150_name._native_ptr(), 1740695150)
        ...
        self._method_set_post_gain_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_post_gain_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_post_gain_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_post_gain_1740695150_name._native_ptr(), 1740695150)
    ...
    public func get_mode() -> AudioEffectDistortion.Mode {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return AudioEffectDistortion.Mode(from: __resPtr.pointee)
    }
