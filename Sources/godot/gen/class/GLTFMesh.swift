...
open class GLTFMesh : Resource {
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        self._method_get_mesh_3754628756 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFMesh._native_ptr(), _method_get_mesh_3754628756_name._native_ptr(), 3754628756)
        assert(GLTFMesh._method_get_mesh_3754628756 != nil)
        let _method_set_mesh_2255166972_name = StringName(from: "set_mesh")
        self._method_set_mesh_2255166972 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFMesh._native_ptr(), _method_set_mesh_2255166972_name._native_ptr(), 2255166972)
        ...
        self._method_get_blend_weights_2445143706 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFMesh._native_ptr(), _method_get_blend_weights_2445143706_name._native_ptr(), 2445143706)
        ...
        self._method_set_blend_weights_2899603908 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFMesh._native_ptr(), _method_set_blend_weights_2899603908_name._native_ptr(), 2899603908)
        ...
        self._method_get_instance_materials_2915620761 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFMesh._native_ptr(), _method_get_instance_materials_2915620761_name._native_ptr(), 2915620761)
        ...
        self._method_set_instance_materials_381264803 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFMesh._native_ptr(), _method_set_instance_materials_381264803_name._native_ptr(), 381264803)
