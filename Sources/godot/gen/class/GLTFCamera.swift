...
open class GLTFCamera : Resource {
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        self._method_from_node_237784 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFCamera._native_ptr(), _method_from_node_237784_name._native_ptr(), 237784)
        assert(GLTFCamera._method_from_node_237784 != nil)
        let _method_to_node_2285090890_name = StringName(from: "to_node")
        self._method_to_node_2285090890 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFCamera._native_ptr(), _method_to_node_2285090890_name._native_ptr(), 2285090890)
        ...
        self._method_from_dictionary_2495512509 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFCamera._native_ptr(), _method_from_dictionary_2495512509_name._native_ptr(), 2495512509)
        ...
        self._method_to_dictionary_3102165223 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFCamera._native_ptr(), _method_to_dictionary_3102165223_name._native_ptr(), 3102165223)
        ...
        self._method_get_perspective_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFCamera._native_ptr(), _method_get_perspective_36873697_name._native_ptr(), 36873697)
        ...
        self._method_set_perspective_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFCamera._native_ptr(), _method_set_perspective_2586408642_name._native_ptr(), 2586408642)
        assert(GLTFCamera._method_set_perspective_2586408642 != nil)
        let _method_get_fov_1740695150_name = StringName(from: "get_fov")
        self._method_get_fov_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFCamera._native_ptr(), _method_get_fov_1740695150_name._native_ptr(), 1740695150)
        assert(GLTFCamera._method_get_fov_1740695150 != nil)
        let _method_set_fov_373806689_name = StringName(from: "set_fov")
        self._method_set_fov_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFCamera._native_ptr(), _method_set_fov_373806689_name._native_ptr(), 373806689)
        assert(GLTFCamera._method_set_fov_373806689 != nil)
        let _method_get_size_mag_1740695150_name = StringName(from: "get_size_mag")
        self._method_get_size_mag_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFCamera._native_ptr(), _method_get_size_mag_1740695150_name._native_ptr(), 1740695150)
        ...
        self._method_set_size_mag_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFCamera._native_ptr(), _method_set_size_mag_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_depth_far_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFCamera._native_ptr(), _method_get_depth_far_1740695150_name._native_ptr(), 1740695150)
        ...
        self._method_set_depth_far_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFCamera._native_ptr(), _method_set_depth_far_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_depth_near_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFCamera._native_ptr(), _method_get_depth_near_1740695150_name._native_ptr(), 1740695150)
        ...
        self._method_set_depth_near_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFCamera._native_ptr(), _method_set_depth_near_373806689_name._native_ptr(), 373806689)
