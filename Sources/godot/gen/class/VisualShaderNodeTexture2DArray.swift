...
public class VisualShaderNodeTexture2DArray : VisualShaderNodeSample3D {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_texture_array_2206200446 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_texture_array_2206200446_name._native_ptr(), 2206200446)
        ...
        self._method_get_texture_array_146117123 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_texture_array_146117123_name._native_ptr(), 146117123)
    ...
    public func get_texture_array() -> Texture2DArray {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return Texture2DArray(from: __resPtr.pointee)
    }
}