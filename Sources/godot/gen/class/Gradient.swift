...
public class Gradient : Resource {
    ...
    public override class func initialize_class() {
        ...
        self._method_add_point_3629403827 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_add_point_3629403827_name._native_ptr(), 3629403827)
        ...
        self._method_set_offset_1602489585 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_offset_1602489585_name._native_ptr(), 1602489585)
        assert(Gradient._method_set_offset_1602489585 != nil)
        let _method_get_offset_4025615559_name = StringName(from: "get_offset")
        self._method_get_offset_4025615559 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_offset_4025615559_name._native_ptr(), 4025615559)
        assert(Gradient._method_get_offset_4025615559 != nil)
        let _method_reverse_3218959716_name = StringName(from: "reverse")
        self._method_reverse_3218959716 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_reverse_3218959716_name._native_ptr(), 3218959716)
        assert(Gradient._method_reverse_3218959716 != nil)
        let _method_set_color_2878471219_name = StringName(from: "set_color")
        self._method_set_color_2878471219 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_color_2878471219_name._native_ptr(), 2878471219)
        assert(Gradient._method_set_color_2878471219 != nil)
        let _method_get_color_2624840992_name = StringName(from: "get_color")
        self._method_get_color_2624840992 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_color_2624840992_name._native_ptr(), 2624840992)
        assert(Gradient._method_get_color_2624840992 != nil)
        let _method_sample_1250405064_name = StringName(from: "sample")
        self._method_sample_1250405064 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_sample_1250405064_name._native_ptr(), 1250405064)
        ...
        self._method_set_offsets_2899603908 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_offsets_2899603908_name._native_ptr(), 2899603908)
        assert(Gradient._method_set_offsets_2899603908 != nil)
        let _method_get_offsets_675695659_name = StringName(from: "get_offsets")
        self._method_get_offsets_675695659 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_offsets_675695659_name._native_ptr(), 675695659)
        assert(Gradient._method_get_offsets_675695659 != nil)
        let _method_set_colors_3546319833_name = StringName(from: "set_colors")
        self._method_set_colors_3546319833 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_colors_3546319833_name._native_ptr(), 3546319833)
        assert(Gradient._method_set_colors_3546319833 != nil)
        let _method_get_colors_1392750486_name = StringName(from: "get_colors")
        self._method_get_colors_1392750486 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_colors_1392750486_name._native_ptr(), 1392750486)
        ...
        self._method_set_interpolation_mode_1971444490 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_interpolation_mode_1971444490_name._native_ptr(), 1971444490)
        ...
        self._method_get_interpolation_mode_3674172981 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_interpolation_mode_3674172981_name._native_ptr(), 3674172981)
    ...
    public func get_interpolation_mode() -> Gradient.InterpolationMode {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return Gradient.InterpolationMode(from: __resPtr.pointee)
    }
}