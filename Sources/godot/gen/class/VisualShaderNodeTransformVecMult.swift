...
public class VisualShaderNodeTransformVecMult : VisualShaderNode {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_operator_1785665912 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_operator_1785665912_name._native_ptr(), 1785665912)
        ...
        self._method_get_operator_1622088722 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_operator_1622088722_name._native_ptr(), 1622088722)
    ...
    public func get_operator() -> VisualShaderNodeTransformVecMult.Operator {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return VisualShaderNodeTransformVecMult.Operator(from: __resPtr.pointee)
    }
}