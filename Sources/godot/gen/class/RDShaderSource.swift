...
/// 
/// 
public class RDShaderSource : RefCounted {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_stage_source_620821314 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_stage_source_620821314_name._native_ptr(), 620821314)
        ...
        self._method_get_stage_source_3354920045 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_stage_source_3354920045_name._native_ptr(), 3354920045)
        ...
        self._method_set_language_3422186742 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_language_3422186742_name._native_ptr(), 3422186742)
        ...
        self._method_get_language_1063538261 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_language_1063538261_name._native_ptr(), 1063538261)
        assert(RDShaderSource._method_get_language_1063538261 != nil)
    }

    public func set_stage_source(stage: RenderingDevice.ShaderStage, source: String)  {
    ...
    public func get_stage_source(stage: RenderingDevice.ShaderStage) -> String {
        withUnsafePointer(to: stage.rawValue) { stage_native in
    ...
    public func get_language() -> RenderingDevice.ShaderLanguage {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return RenderingDevice.ShaderLanguage(from: __resPtr.pointee)
    }
}