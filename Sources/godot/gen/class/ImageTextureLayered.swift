...
public class ImageTextureLayered : TextureLayered {
    ...
    public override class func initialize_class() {
        ...
        self._method_create_from_images_2785773503 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_create_from_images_2785773503_name._native_ptr(), 2785773503)
        ...
        self._method_update_layer_3331733361 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_update_layer_3331733361_name._native_ptr(), 3331733361)
