...
public class MultiplayerSpawner : Node {
    ...
    public override class func initialize_class() {
        ...
        self._method_add_spawnable_scene_83702148 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_add_spawnable_scene_83702148_name._native_ptr(), 83702148)
        ...
        self._method_get_spawnable_scene_count_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_spawnable_scene_count_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_get_spawnable_scene_844755477 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_spawnable_scene_844755477_name._native_ptr(), 844755477)
        ...
        self._method_clear_spawnable_scenes_3218959716 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_clear_spawnable_scenes_3218959716_name._native_ptr(), 3218959716)
        ...
        self._method_spawn_1991184589 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_spawn_1991184589_name._native_ptr(), 1991184589)
        ...
        self._method_get_spawn_path_4075236667 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_spawn_path_4075236667_name._native_ptr(), 4075236667)
        ...
        self._method_set_spawn_path_1348162250 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_spawn_path_1348162250_name._native_ptr(), 1348162250)
        ...
        self._method_get_spawn_limit_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_spawn_limit_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_set_spawn_limit_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_spawn_limit_1286410249_name._native_ptr(), 1286410249)
        ...
        self._method_get_spawn_function_1307783378 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_spawn_function_1307783378_name._native_ptr(), 1307783378)
        ...
        self._method_set_spawn_function_1611583062 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_spawn_function_1611583062_name._native_ptr(), 1611583062)
        assert(MultiplayerSpawner._method_set_spawn_function_1611583062 != nil)
    }

    public func add_spawnable_scene(path: String)  {
    ...
    public func get_spawnable_scene(index: Int64) -> String {
