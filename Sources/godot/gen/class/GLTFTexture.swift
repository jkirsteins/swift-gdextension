...
open class GLTFTexture : Resource {
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        self._method_get_src_image_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFTexture._native_ptr(), _method_get_src_image_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_set_src_image_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFTexture._native_ptr(), _method_set_src_image_1286410249_name._native_ptr(), 1286410249)
        ...
        self._method_get_sampler_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFTexture._native_ptr(), _method_get_sampler_3905245786_name._native_ptr(), 3905245786)
        assert(GLTFTexture._method_get_sampler_3905245786 != nil)
        let _method_set_sampler_1286410249_name = StringName(from: "set_sampler")
        self._method_set_sampler_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFTexture._native_ptr(), _method_set_sampler_1286410249_name._native_ptr(), 1286410249)
