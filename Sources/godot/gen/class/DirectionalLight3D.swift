...
public class DirectionalLight3D : Light3D {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_shadow_mode_1261211726 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_shadow_mode_1261211726_name._native_ptr(), 1261211726)
        ...
        self._method_get_shadow_mode_2765228544 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_shadow_mode_2765228544_name._native_ptr(), 2765228544)
        ...
        self._method_set_blend_splits_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_blend_splits_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_is_blend_splits_enabled_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_is_blend_splits_enabled_36873697_name._native_ptr(), 36873697)
        ...
        self._method_set_sky_mode_2691194817 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_sky_mode_2691194817_name._native_ptr(), 2691194817)
        ...
        self._method_get_sky_mode_3819982774 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_sky_mode_3819982774_name._native_ptr(), 3819982774)
    ...
    public func get_shadow_mode() -> DirectionalLight3D.ShadowMode {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return DirectionalLight3D.ShadowMode(from: __resPtr.pointee)
    }
    ...
    public func get_sky_mode() -> DirectionalLight3D.SkyMode {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return DirectionalLight3D.SkyMode(from: __resPtr.pointee)
    }
}