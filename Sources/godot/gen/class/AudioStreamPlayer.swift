...
open class AudioStreamPlayer : Node {
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        self._method_set_stream_2210767741 = self.interface.pointee.classdb_get_method_bind(__godot_name_AudioStreamPlayer._native_ptr(), _method_set_stream_2210767741_name._native_ptr(), 2210767741)
        ...
        self._method_get_stream_160907539 = self.interface.pointee.classdb_get_method_bind(__godot_name_AudioStreamPlayer._native_ptr(), _method_get_stream_160907539_name._native_ptr(), 160907539)
        ...
        self._method_set_volume_db_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name_AudioStreamPlayer._native_ptr(), _method_set_volume_db_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_volume_db_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name_AudioStreamPlayer._native_ptr(), _method_get_volume_db_1740695150_name._native_ptr(), 1740695150)
        ...
        self._method_set_pitch_scale_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name_AudioStreamPlayer._native_ptr(), _method_set_pitch_scale_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_pitch_scale_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name_AudioStreamPlayer._native_ptr(), _method_get_pitch_scale_1740695150_name._native_ptr(), 1740695150)
        assert(AudioStreamPlayer._method_get_pitch_scale_1740695150 != nil)
        let _method_play_3041634712_name = StringName(from: "play")
        self._method_play_3041634712 = self.interface.pointee.classdb_get_method_bind(__godot_name_AudioStreamPlayer._native_ptr(), _method_play_3041634712_name._native_ptr(), 3041634712)
        assert(AudioStreamPlayer._method_play_3041634712 != nil)
        let _method_seek_373806689_name = StringName(from: "seek")
        self._method_seek_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name_AudioStreamPlayer._native_ptr(), _method_seek_373806689_name._native_ptr(), 373806689)
        assert(AudioStreamPlayer._method_seek_373806689 != nil)
        let _method_stop_3218959716_name = StringName(from: "stop")
        self._method_stop_3218959716 = self.interface.pointee.classdb_get_method_bind(__godot_name_AudioStreamPlayer._native_ptr(), _method_stop_3218959716_name._native_ptr(), 3218959716)
        assert(AudioStreamPlayer._method_stop_3218959716 != nil)
        let _method_is_playing_36873697_name = StringName(from: "is_playing")
        self._method_is_playing_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name_AudioStreamPlayer._native_ptr(), _method_is_playing_36873697_name._native_ptr(), 36873697)
        ...
        self._method_get_playback_position_191475506 = self.interface.pointee.classdb_get_method_bind(__godot_name_AudioStreamPlayer._native_ptr(), _method_get_playback_position_191475506_name._native_ptr(), 191475506)
        ...
        self._method_set_bus_3304788590 = self.interface.pointee.classdb_get_method_bind(__godot_name_AudioStreamPlayer._native_ptr(), _method_set_bus_3304788590_name._native_ptr(), 3304788590)
        assert(AudioStreamPlayer._method_set_bus_3304788590 != nil)
        let _method_get_bus_2002593661_name = StringName(from: "get_bus")
        self._method_get_bus_2002593661 = self.interface.pointee.classdb_get_method_bind(__godot_name_AudioStreamPlayer._native_ptr(), _method_get_bus_2002593661_name._native_ptr(), 2002593661)
        ...
        self._method_set_autoplay_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name_AudioStreamPlayer._native_ptr(), _method_set_autoplay_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_is_autoplay_enabled_2240911060 = self.interface.pointee.classdb_get_method_bind(__godot_name_AudioStreamPlayer._native_ptr(), _method_is_autoplay_enabled_2240911060_name._native_ptr(), 2240911060)
        ...
        self._method_set_mix_target_2300306138 = self.interface.pointee.classdb_get_method_bind(__godot_name_AudioStreamPlayer._native_ptr(), _method_set_mix_target_2300306138_name._native_ptr(), 2300306138)
        ...
        self._method_get_mix_target_172807476 = self.interface.pointee.classdb_get_method_bind(__godot_name_AudioStreamPlayer._native_ptr(), _method_get_mix_target_172807476_name._native_ptr(), 172807476)
        ...
        self._method_set_stream_paused_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name_AudioStreamPlayer._native_ptr(), _method_set_stream_paused_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_get_stream_paused_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name_AudioStreamPlayer._native_ptr(), _method_get_stream_paused_36873697_name._native_ptr(), 36873697)
        ...
        self._method_set_max_polyphony_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name_AudioStreamPlayer._native_ptr(), _method_set_max_polyphony_1286410249_name._native_ptr(), 1286410249)
        ...
        self._method_get_max_polyphony_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name_AudioStreamPlayer._native_ptr(), _method_get_max_polyphony_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_has_stream_playback_2240911060 = self.interface.pointee.classdb_get_method_bind(__godot_name_AudioStreamPlayer._native_ptr(), _method_has_stream_playback_2240911060_name._native_ptr(), 2240911060)
        ...
        self._method_get_stream_playback_210135309 = self.interface.pointee.classdb_get_method_bind(__godot_name_AudioStreamPlayer._native_ptr(), _method_get_stream_playback_210135309_name._native_ptr(), 210135309)
