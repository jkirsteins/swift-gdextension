...
public class PacketPeerDTLS : PacketPeer {
    ...
    public override class func initialize_class() {
        ...
        self._method_connect_to_peer_1801538152 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_connect_to_peer_1801538152_name._native_ptr(), 1801538152)
        ...
        self._method_get_status_3248654679 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_status_3248654679_name._native_ptr(), 3248654679)
        ...
        self._method_disconnect_from_peer_3218959716 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_disconnect_from_peer_3218959716_name._native_ptr(), 3218959716)
    ...
    public func connect_to_peer(packet_peer: PacketPeerUDP, hostname: String, client_options: TLSOptions) -> Error {
    ...
    public func get_status() -> PacketPeerDTLS.Status {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return PacketPeerDTLS.Status(from: __resPtr.pointee)
    }
