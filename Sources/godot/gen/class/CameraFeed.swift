...
public class CameraFeed : RefCounted {
    ...
    public override class func initialize_class() {
        ...
        self._method_get_position_2711679033 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_position_2711679033_name._native_ptr(), 2711679033)
        ...
        self._method_get_datatype_1477782850 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_datatype_1477782850_name._native_ptr(), 1477782850)
    ...
    public func get_position() -> CameraFeed.FeedPosition {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return CameraFeed.FeedPosition(from: __resPtr.pointee)
    }
    ...
    public func get_datatype() -> CameraFeed.FeedDataType {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return CameraFeed.FeedDataType(from: __resPtr.pointee)
    }
}