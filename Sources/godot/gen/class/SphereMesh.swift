...
open class SphereMesh : PrimitiveMesh {
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        self._method_set_radius_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name_SphereMesh._native_ptr(), _method_set_radius_373806689_name._native_ptr(), 373806689)
        assert(SphereMesh._method_set_radius_373806689 != nil)
        let _method_get_radius_1740695150_name = StringName(from: "get_radius")
        self._method_get_radius_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name_SphereMesh._native_ptr(), _method_get_radius_1740695150_name._native_ptr(), 1740695150)
        assert(SphereMesh._method_get_radius_1740695150 != nil)
        let _method_set_height_373806689_name = StringName(from: "set_height")
        self._method_set_height_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name_SphereMesh._native_ptr(), _method_set_height_373806689_name._native_ptr(), 373806689)
        assert(SphereMesh._method_set_height_373806689 != nil)
        let _method_get_height_1740695150_name = StringName(from: "get_height")
        self._method_get_height_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name_SphereMesh._native_ptr(), _method_get_height_1740695150_name._native_ptr(), 1740695150)
        ...
        self._method_set_radial_segments_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name_SphereMesh._native_ptr(), _method_set_radial_segments_1286410249_name._native_ptr(), 1286410249)
        ...
        self._method_get_radial_segments_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name_SphereMesh._native_ptr(), _method_get_radial_segments_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_set_rings_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name_SphereMesh._native_ptr(), _method_set_rings_1286410249_name._native_ptr(), 1286410249)
        assert(SphereMesh._method_set_rings_1286410249 != nil)
        let _method_get_rings_3905245786_name = StringName(from: "get_rings")
        self._method_get_rings_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name_SphereMesh._native_ptr(), _method_get_rings_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_set_is_hemisphere_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name_SphereMesh._native_ptr(), _method_set_is_hemisphere_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_get_is_hemisphere_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name_SphereMesh._native_ptr(), _method_get_is_hemisphere_36873697_name._native_ptr(), 36873697)
