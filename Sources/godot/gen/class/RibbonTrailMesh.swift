...
/// 
/// 
public class RibbonTrailMesh : PrimitiveMesh {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_section_segments_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_section_segments_1286410249_name._native_ptr(), 1286410249)
        ...
        self._method_get_section_segments_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_section_segments_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_set_shape_1684440262 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_shape_1684440262_name._native_ptr(), 1684440262)
        assert(RibbonTrailMesh._method_set_shape_1684440262 != nil)
        let _method_get_shape_1317484155_name = StringName(from: "get_shape")
        self._method_get_shape_1317484155 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_shape_1317484155_name._native_ptr(), 1317484155)
    ...
    public func get_shape() -> RibbonTrailMesh.Shape {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return RibbonTrailMesh.Shape(from: __resPtr.pointee)
    }
}