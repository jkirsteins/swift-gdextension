...
public class ThemeDB : Object {
    ...
    public override class func initialize_class() {
        ...
        self._method_get_default_theme_754276358 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_default_theme_754276358_name._native_ptr(), 754276358)
        ...
        self._method_get_project_theme_754276358 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_project_theme_754276358_name._native_ptr(), 754276358)
        ...
        self._method_set_fallback_base_scale_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_fallback_base_scale_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_fallback_base_scale_191475506 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_fallback_base_scale_191475506_name._native_ptr(), 191475506)
        ...
        self._method_set_fallback_font_1262170328 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_fallback_font_1262170328_name._native_ptr(), 1262170328)
        ...
        self._method_get_fallback_font_3656929885 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_fallback_font_3656929885_name._native_ptr(), 3656929885)
        ...
        self._method_set_fallback_font_size_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_fallback_font_size_1286410249_name._native_ptr(), 1286410249)
        ...
        self._method_get_fallback_font_size_2455072627 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_fallback_font_size_2455072627_name._native_ptr(), 2455072627)
        ...
        self._method_set_fallback_icon_4051416890 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_fallback_icon_4051416890_name._native_ptr(), 4051416890)
        ...
        self._method_get_fallback_icon_255860311 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_fallback_icon_255860311_name._native_ptr(), 255860311)
        ...
        self._method_set_fallback_stylebox_2797200388 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_fallback_stylebox_2797200388_name._native_ptr(), 2797200388)
        ...
        self._method_get_fallback_stylebox_496040854 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_fallback_stylebox_496040854_name._native_ptr(), 496040854)
