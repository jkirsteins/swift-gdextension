...
public class SkeletonProfile : Resource {
    ...
    public override class func initialize_class() {
        ...
        self._method_get_root_bone_2737447660 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_root_bone_2737447660_name._native_ptr(), 2737447660)
        ...
        self._method_set_scale_base_bone_3304788590 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_scale_base_bone_3304788590_name._native_ptr(), 3304788590)
        ...
        self._method_get_scale_base_bone_2737447660 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_scale_base_bone_2737447660_name._native_ptr(), 2737447660)
        ...
        self._method_set_group_size_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_group_size_1286410249_name._native_ptr(), 1286410249)
        ...
        self._method_get_group_size_2455072627 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_group_size_2455072627_name._native_ptr(), 2455072627)
        ...
        self._method_get_group_name_659327637 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_group_name_659327637_name._native_ptr(), 659327637)
        ...
        self._method_set_group_name_3780747571 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_group_name_3780747571_name._native_ptr(), 3780747571)
        ...
        self._method_get_texture_3536238170 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_texture_3536238170_name._native_ptr(), 3536238170)
        ...
        self._method_set_texture_666127730 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_texture_666127730_name._native_ptr(), 666127730)
        ...
        self._method_set_bone_size_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_bone_size_1286410249_name._native_ptr(), 1286410249)
        ...
        self._method_get_bone_size_2455072627 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_bone_size_2455072627_name._native_ptr(), 2455072627)
        ...
        self._method_find_bone_2458036349 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_find_bone_2458036349_name._native_ptr(), 2458036349)
        ...
        self._method_get_bone_name_659327637 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_bone_name_659327637_name._native_ptr(), 659327637)
        ...
        self._method_set_bone_name_3780747571 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_bone_name_3780747571_name._native_ptr(), 3780747571)
        ...
        self._method_get_bone_parent_659327637 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_bone_parent_659327637_name._native_ptr(), 659327637)
        ...
        self._method_set_bone_parent_3780747571 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_bone_parent_3780747571_name._native_ptr(), 3780747571)
        ...
        self._method_get_tail_direction_2675997574 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_tail_direction_2675997574_name._native_ptr(), 2675997574)
        ...
        self._method_set_tail_direction_1231951015 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_tail_direction_1231951015_name._native_ptr(), 1231951015)
        ...
        self._method_get_bone_tail_659327637 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_bone_tail_659327637_name._native_ptr(), 659327637)
        ...
        self._method_set_bone_tail_3780747571 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_bone_tail_3780747571_name._native_ptr(), 3780747571)
        ...
        self._method_get_reference_pose_1965739696 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_reference_pose_1965739696_name._native_ptr(), 1965739696)
        ...
        self._method_set_reference_pose_3616898986 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_reference_pose_3616898986_name._native_ptr(), 3616898986)
        ...
        self._method_get_handle_offset_2299179447 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_handle_offset_2299179447_name._native_ptr(), 2299179447)
        ...
        self._method_set_handle_offset_163021252 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_handle_offset_163021252_name._native_ptr(), 163021252)
        ...
        self._method_get_group_659327637 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_group_659327637_name._native_ptr(), 659327637)
        assert(SkeletonProfile._method_get_group_659327637 != nil)
        let _method_set_group_3780747571_name = StringName(from: "set_group")
        self._method_set_group_3780747571 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_group_3780747571_name._native_ptr(), 3780747571)
    ...
    public func get_tail_direction(bone_idx: Int64) -> SkeletonProfile.TailDirection {
        ...
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            ...
            return SkeletonProfile.TailDirection(from: __resPtr.pointee)
        }
    }
