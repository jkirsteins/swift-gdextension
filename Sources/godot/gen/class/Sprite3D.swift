...
open class Sprite3D : SpriteBase3D {
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        self._method_set_texture_4051416890 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite3D._native_ptr(), _method_set_texture_4051416890_name._native_ptr(), 4051416890)
        assert(Sprite3D._method_set_texture_4051416890 != nil)
        let _method_get_texture_3635182373_name = StringName(from: "get_texture")
        self._method_get_texture_3635182373 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite3D._native_ptr(), _method_get_texture_3635182373_name._native_ptr(), 3635182373)
        ...
        self._method_set_region_enabled_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite3D._native_ptr(), _method_set_region_enabled_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_is_region_enabled_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite3D._native_ptr(), _method_is_region_enabled_36873697_name._native_ptr(), 36873697)
        ...
        self._method_set_region_rect_2046264180 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite3D._native_ptr(), _method_set_region_rect_2046264180_name._native_ptr(), 2046264180)
        ...
        self._method_get_region_rect_1639390495 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite3D._native_ptr(), _method_get_region_rect_1639390495_name._native_ptr(), 1639390495)
        assert(Sprite3D._method_get_region_rect_1639390495 != nil)
        let _method_set_frame_1286410249_name = StringName(from: "set_frame")
        self._method_set_frame_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite3D._native_ptr(), _method_set_frame_1286410249_name._native_ptr(), 1286410249)
        assert(Sprite3D._method_set_frame_1286410249 != nil)
        let _method_get_frame_3905245786_name = StringName(from: "get_frame")
        self._method_get_frame_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite3D._native_ptr(), _method_get_frame_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_set_frame_coords_1130785943 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite3D._native_ptr(), _method_set_frame_coords_1130785943_name._native_ptr(), 1130785943)
        ...
        self._method_get_frame_coords_3690982128 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite3D._native_ptr(), _method_get_frame_coords_3690982128_name._native_ptr(), 3690982128)
        ...
        self._method_set_vframes_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite3D._native_ptr(), _method_set_vframes_1286410249_name._native_ptr(), 1286410249)
        assert(Sprite3D._method_set_vframes_1286410249 != nil)
        let _method_get_vframes_3905245786_name = StringName(from: "get_vframes")
        self._method_get_vframes_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite3D._native_ptr(), _method_get_vframes_3905245786_name._native_ptr(), 3905245786)
        assert(Sprite3D._method_get_vframes_3905245786 != nil)
        let _method_set_hframes_1286410249_name = StringName(from: "set_hframes")
        self._method_set_hframes_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite3D._native_ptr(), _method_set_hframes_1286410249_name._native_ptr(), 1286410249)
        assert(Sprite3D._method_set_hframes_1286410249 != nil)
        let _method_get_hframes_3905245786_name = StringName(from: "get_hframes")
        self._method_get_hframes_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite3D._native_ptr(), _method_get_hframes_3905245786_name._native_ptr(), 3905245786)
