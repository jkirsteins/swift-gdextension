...
public class XMLParser : RefCounted {
    ...
    public override class func initialize_class() {
        ...
        self._method_read_166280745 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_read_166280745_name._native_ptr(), 166280745)
        assert(XMLParser._method_read_166280745 != nil)
        let _method_get_node_type_2984359541_name = StringName(from: "get_node_type")
        self._method_get_node_type_2984359541 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_node_type_2984359541_name._native_ptr(), 2984359541)
        ...
        self._method_get_node_name_201670096 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_node_name_201670096_name._native_ptr(), 201670096)
        ...
        self._method_get_node_data_201670096 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_node_data_201670096_name._native_ptr(), 201670096)
        ...
        self._method_get_node_offset_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_node_offset_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_get_attribute_count_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_attribute_count_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_get_attribute_name_844755477 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_attribute_name_844755477_name._native_ptr(), 844755477)
        ...
        self._method_get_attribute_value_844755477 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_attribute_value_844755477_name._native_ptr(), 844755477)
        ...
        self._method_has_attribute_3927539163 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_has_attribute_3927539163_name._native_ptr(), 3927539163)
        ...
        self._method_get_named_attribute_value_3135753539 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_named_attribute_value_3135753539_name._native_ptr(), 3135753539)
        ...
        self._method_get_named_attribute_value_safe_3135753539 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_named_attribute_value_safe_3135753539_name._native_ptr(), 3135753539)
        ...
        self._method_get_current_line_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_current_line_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_skip_section_3218959716 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_skip_section_3218959716_name._native_ptr(), 3218959716)
        assert(XMLParser._method_skip_section_3218959716 != nil)
        let _method_seek_844576869_name = StringName(from: "seek")
        self._method_seek_844576869 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_seek_844576869_name._native_ptr(), 844576869)
        assert(XMLParser._method_seek_844576869 != nil)
        let _method_open_166001499_name = StringName(from: "open")
        self._method_open_166001499 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_open_166001499_name._native_ptr(), 166001499)
        assert(XMLParser._method_open_166001499 != nil)
        let _method_open_buffer_680677267_name = StringName(from: "open_buffer")
        self._method_open_buffer_680677267 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_open_buffer_680677267_name._native_ptr(), 680677267)
    ...
    public func get_node_type() -> XMLParser.NodeType {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return XMLParser.NodeType(from: __resPtr.pointee)
    }
    ...
    public func get_node_data() -> String {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            defer { args.deallocate() }
            _ = args.initialize(from: [
    ...
    public func get_attribute_name(idx: Int64) -> String {
    ...
    public func get_attribute_value(idx: Int64) -> String {
        withUnsafePointer(to: idx) { idx_native in
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            defer { args.deallocate() }
            _ = args.initialize(from: [
    ...
    public func has_attribute(name: String) -> UInt8 {
    ...
    public func get_named_attribute_value(name: String) -> String {
        withUnsafePointer(to: name) { name_native in
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            defer { args.deallocate() }
            _ = args.initialize(from: [
    ...
    public func get_named_attribute_value_safe(name: String) -> String {
        withUnsafePointer(to: name) { name_native in
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            defer { args.deallocate() }
            _ = args.initialize(from: [
    ...
    public func open(file: String) -> Error {
