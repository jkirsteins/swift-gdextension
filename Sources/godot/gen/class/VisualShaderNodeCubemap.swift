...
public class VisualShaderNodeCubemap : VisualShaderNode {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_source_1625400621 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_source_1625400621_name._native_ptr(), 1625400621)
        ...
        self._method_get_source_2222048781 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_source_2222048781_name._native_ptr(), 2222048781)
        ...
        self._method_set_cube_map_2219800736 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_cube_map_2219800736_name._native_ptr(), 2219800736)
        ...
        self._method_get_cube_map_1772111058 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_cube_map_1772111058_name._native_ptr(), 1772111058)
        ...
        self._method_set_texture_type_1899718876 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_texture_type_1899718876_name._native_ptr(), 1899718876)
        ...
        self._method_get_texture_type_3356498888 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_texture_type_3356498888_name._native_ptr(), 3356498888)
    ...
    public func get_source() -> VisualShaderNodeCubemap.Source {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return VisualShaderNodeCubemap.Source(from: __resPtr.pointee)
    }
    ...
    public func get_cube_map() -> Cubemap {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return Cubemap(from: __resPtr.pointee)
    }
    ...
    public func get_texture_type() -> VisualShaderNodeCubemap.TextureType {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return VisualShaderNodeCubemap.TextureType(from: __resPtr.pointee)
    }
}