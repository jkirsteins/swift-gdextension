...
public class MeshLibrary : Resource {
    ...
    public override class func initialize_class() {
        ...
        self._method_create_item_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_create_item_1286410249_name._native_ptr(), 1286410249)
        ...
        self._method_set_item_name_501894301 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_item_name_501894301_name._native_ptr(), 501894301)
        ...
        self._method_set_item_mesh_969122797 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_item_mesh_969122797_name._native_ptr(), 969122797)
        ...
        self._method_set_item_mesh_transform_3616898986 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_item_mesh_transform_3616898986_name._native_ptr(), 3616898986)
        ...
        self._method_set_item_navigation_mesh_3483353960 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_item_navigation_mesh_3483353960_name._native_ptr(), 3483353960)
        ...
        self._method_set_item_navigation_mesh_transform_3616898986 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_item_navigation_mesh_transform_3616898986_name._native_ptr(), 3616898986)
        ...
        self._method_set_item_navigation_layers_3937882851 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_item_navigation_layers_3937882851_name._native_ptr(), 3937882851)
        ...
        self._method_set_item_shapes_537221740 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_item_shapes_537221740_name._native_ptr(), 537221740)
        ...
        self._method_set_item_preview_666127730 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_item_preview_666127730_name._native_ptr(), 666127730)
        ...
        self._method_get_item_name_844755477 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_item_name_844755477_name._native_ptr(), 844755477)
        ...
        self._method_get_item_mesh_1576363275 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_item_mesh_1576363275_name._native_ptr(), 1576363275)
        ...
        self._method_get_item_mesh_transform_1965739696 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_item_mesh_transform_1965739696_name._native_ptr(), 1965739696)
        ...
        self._method_get_item_navigation_mesh_2729647406 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_item_navigation_mesh_2729647406_name._native_ptr(), 2729647406)
        ...
        self._method_get_item_navigation_mesh_transform_1965739696 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_item_navigation_mesh_transform_1965739696_name._native_ptr(), 1965739696)
        ...
        self._method_get_item_navigation_layers_923996154 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_item_navigation_layers_923996154_name._native_ptr(), 923996154)
        ...
        self._method_get_item_shapes_663333327 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_item_shapes_663333327_name._native_ptr(), 663333327)
        ...
        self._method_get_item_preview_3536238170 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_item_preview_3536238170_name._native_ptr(), 3536238170)
        ...
        self._method_find_item_by_name_1321353865 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_find_item_by_name_1321353865_name._native_ptr(), 1321353865)
        ...
        self._method_get_item_list_1930428628 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_item_list_1930428628_name._native_ptr(), 1930428628)
        ...
        self._method_get_last_unused_item_id_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_last_unused_item_id_3905245786_name._native_ptr(), 3905245786)
    ...
    public func set_item_name(id: Int64, name: String)  {
    ...
    public func get_item_name(id: Int64) -> String {
        withUnsafePointer(to: id) { id_native in
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            defer { args.deallocate() }
            _ = args.initialize(from: [
    ...
    public func find_item_by_name(name: String) -> Int64 {
        withUnsafePointer(to: name) { name_native in
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            defer { args.deallocate() }
            _ = args.initialize(from: [
