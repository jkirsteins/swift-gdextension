...
/// 
/// MISSING
public class WebRTCDataChannel : PacketPeer {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_write_mode_1999768052 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_write_mode_1999768052_name._native_ptr(), 1999768052)
        ...
        self._method_get_write_mode_2848495172 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_write_mode_2848495172_name._native_ptr(), 2848495172)
        ...
        self._method_get_ready_state_3501143017 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_ready_state_3501143017_name._native_ptr(), 3501143017)
        ...
        self._method_is_ordered_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_is_ordered_36873697_name._native_ptr(), 36873697)
        assert(WebRTCDataChannel._method_is_ordered_36873697 != nil)
        let _method_get_id_3905245786_name = StringName(from: "get_id")
        self._method_get_id_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_id_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_get_max_packet_life_time_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_max_packet_life_time_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_get_max_retransmits_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_max_retransmits_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_get_protocol_201670096 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_protocol_201670096_name._native_ptr(), 201670096)
        ...
        self._method_is_negotiated_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_is_negotiated_36873697_name._native_ptr(), 36873697)
        ...
        self._method_get_buffered_amount_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_buffered_amount_3905245786_name._native_ptr(), 3905245786)
    ...
    public func get_protocol() -> String {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            defer { args.deallocate() }
            _ = args.initialize(from: [
