...
open class VisualShaderNodeBooleanConstant : VisualShaderNodeConstant {
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        self._method_set_constant_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name_VisualShaderNodeBooleanConstant._native_ptr(), _method_set_constant_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_get_constant_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name_VisualShaderNodeBooleanConstant._native_ptr(), _method_get_constant_36873697_name._native_ptr(), 36873697)
