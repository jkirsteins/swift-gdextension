...
open class GLTFNode : Resource {
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        self._method_get_parent_2455072627 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_get_parent_2455072627_name._native_ptr(), 2455072627)
        assert(GLTFNode._method_get_parent_2455072627 != nil)
        let _method_set_parent_1286410249_name = StringName(from: "set_parent")
        self._method_set_parent_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_set_parent_1286410249_name._native_ptr(), 1286410249)
        assert(GLTFNode._method_set_parent_1286410249 != nil)
        let _method_get_height_2455072627_name = StringName(from: "get_height")
        self._method_get_height_2455072627 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_get_height_2455072627_name._native_ptr(), 2455072627)
        assert(GLTFNode._method_get_height_2455072627 != nil)
        let _method_set_height_1286410249_name = StringName(from: "set_height")
        self._method_set_height_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_set_height_1286410249_name._native_ptr(), 1286410249)
        assert(GLTFNode._method_set_height_1286410249 != nil)
        let _method_get_xform_4183770049_name = StringName(from: "get_xform")
        self._method_get_xform_4183770049 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_get_xform_4183770049_name._native_ptr(), 4183770049)
        assert(GLTFNode._method_get_xform_4183770049 != nil)
        let _method_set_xform_2952846383_name = StringName(from: "set_xform")
        self._method_set_xform_2952846383 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_set_xform_2952846383_name._native_ptr(), 2952846383)
        assert(GLTFNode._method_set_xform_2952846383 != nil)
        let _method_get_mesh_2455072627_name = StringName(from: "get_mesh")
        self._method_get_mesh_2455072627 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_get_mesh_2455072627_name._native_ptr(), 2455072627)
        assert(GLTFNode._method_get_mesh_2455072627 != nil)
        let _method_set_mesh_1286410249_name = StringName(from: "set_mesh")
        self._method_set_mesh_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_set_mesh_1286410249_name._native_ptr(), 1286410249)
        assert(GLTFNode._method_set_mesh_1286410249 != nil)
        let _method_get_camera_2455072627_name = StringName(from: "get_camera")
        self._method_get_camera_2455072627 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_get_camera_2455072627_name._native_ptr(), 2455072627)
        assert(GLTFNode._method_get_camera_2455072627 != nil)
        let _method_set_camera_1286410249_name = StringName(from: "set_camera")
        self._method_set_camera_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_set_camera_1286410249_name._native_ptr(), 1286410249)
        assert(GLTFNode._method_set_camera_1286410249 != nil)
        let _method_get_skin_2455072627_name = StringName(from: "get_skin")
        self._method_get_skin_2455072627 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_get_skin_2455072627_name._native_ptr(), 2455072627)
        assert(GLTFNode._method_get_skin_2455072627 != nil)
        let _method_set_skin_1286410249_name = StringName(from: "set_skin")
        self._method_set_skin_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_set_skin_1286410249_name._native_ptr(), 1286410249)
        assert(GLTFNode._method_set_skin_1286410249 != nil)
        let _method_get_skeleton_2455072627_name = StringName(from: "get_skeleton")
        self._method_get_skeleton_2455072627 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_get_skeleton_2455072627_name._native_ptr(), 2455072627)
        assert(GLTFNode._method_get_skeleton_2455072627 != nil)
        let _method_set_skeleton_1286410249_name = StringName(from: "set_skeleton")
        self._method_set_skeleton_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_set_skeleton_1286410249_name._native_ptr(), 1286410249)
        assert(GLTFNode._method_set_skeleton_1286410249 != nil)
        let _method_get_joint_2240911060_name = StringName(from: "get_joint")
        self._method_get_joint_2240911060 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_get_joint_2240911060_name._native_ptr(), 2240911060)
        assert(GLTFNode._method_get_joint_2240911060 != nil)
        let _method_set_joint_2586408642_name = StringName(from: "set_joint")
        self._method_set_joint_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_set_joint_2586408642_name._native_ptr(), 2586408642)
        assert(GLTFNode._method_set_joint_2586408642 != nil)
        let _method_get_position_3783033775_name = StringName(from: "get_position")
        self._method_get_position_3783033775 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_get_position_3783033775_name._native_ptr(), 3783033775)
        assert(GLTFNode._method_get_position_3783033775 != nil)
        let _method_set_position_3460891852_name = StringName(from: "set_position")
        self._method_set_position_3460891852 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_set_position_3460891852_name._native_ptr(), 3460891852)
        assert(GLTFNode._method_set_position_3460891852 != nil)
        let _method_get_rotation_2916281908_name = StringName(from: "get_rotation")
        self._method_get_rotation_2916281908 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_get_rotation_2916281908_name._native_ptr(), 2916281908)
        assert(GLTFNode._method_get_rotation_2916281908 != nil)
        let _method_set_rotation_1727505552_name = StringName(from: "set_rotation")
        self._method_set_rotation_1727505552 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_set_rotation_1727505552_name._native_ptr(), 1727505552)
        assert(GLTFNode._method_set_rotation_1727505552 != nil)
        let _method_get_scale_3783033775_name = StringName(from: "get_scale")
        self._method_get_scale_3783033775 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_get_scale_3783033775_name._native_ptr(), 3783033775)
        assert(GLTFNode._method_get_scale_3783033775 != nil)
        let _method_set_scale_3460891852_name = StringName(from: "set_scale")
        self._method_set_scale_3460891852 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_set_scale_3460891852_name._native_ptr(), 3460891852)
        assert(GLTFNode._method_set_scale_3460891852 != nil)
        let _method_get_children_969006518_name = StringName(from: "get_children")
        self._method_get_children_969006518 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_get_children_969006518_name._native_ptr(), 969006518)
        assert(GLTFNode._method_get_children_969006518 != nil)
        let _method_set_children_3614634198_name = StringName(from: "set_children")
        self._method_set_children_3614634198 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_set_children_3614634198_name._native_ptr(), 3614634198)
        assert(GLTFNode._method_set_children_3614634198 != nil)
        let _method_get_light_2455072627_name = StringName(from: "get_light")
        self._method_get_light_2455072627 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_get_light_2455072627_name._native_ptr(), 2455072627)
        assert(GLTFNode._method_get_light_2455072627 != nil)
        let _method_set_light_1286410249_name = StringName(from: "set_light")
        self._method_set_light_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_set_light_1286410249_name._native_ptr(), 1286410249)
        ...
        self._method_get_additional_data_2138907829 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_get_additional_data_2138907829_name._native_ptr(), 2138907829)
        ...
        self._method_set_additional_data_3776071444 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFNode._native_ptr(), _method_set_additional_data_3776071444_name._native_ptr(), 3776071444)
