...
open class PhysicsTestMotionResult2D : RefCounted {
    ...
    static var _method_get_collision_local_shape_3905245786: StringName! = nil
    static var _method_get_collision_depth_1740695150: StringName! = nil
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        assert(__godot_name_PhysicsTestMotionResult2D == nil)
        ...
        self._method_get_collision_local_shape_3905245786 = StringName(from: "get_collision_local_shape")
        assert(self._method_get_collision_local_shape_3905245786 != nil)
        self._method_get_collision_depth_1740695150 = StringName(from: "get_collision_depth")
        assert(self._method_get_collision_depth_1740695150 != nil)
    ...
    public func get_collision_local_shape() -> Int64 {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            let _mbinding = self.interface.pointee.classdb_get_method_bind(
                    Self.__godot_name._native_ptr(),
                    Self._method_get_collision_local_shape_3905245786._native_ptr(),
                    3905245786)
                assert(_mbinding != nil)
                self.interface.pointee.object_method_bind_ptrcall(
                    _mbinding,
    ...
    public func get_collision_depth() -> Float64 {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            let _mbinding = self.interface.pointee.classdb_get_method_bind(
                    Self.__godot_name._native_ptr(),
                    Self._method_get_collision_depth_1740695150._native_ptr(),
                    1740695150)
                assert(_mbinding != nil)
                self.interface.pointee.object_method_bind_ptrcall(
                    _mbinding,
