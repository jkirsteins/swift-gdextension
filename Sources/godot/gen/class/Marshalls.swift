...
public class Marshalls : Object {
    ...
    public override class func initialize_class() {
        ...
        self._method_variant_to_base64_3876248563 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_variant_to_base64_3876248563_name._native_ptr(), 3876248563)
        ...
        self._method_base64_to_variant_218087648 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_base64_to_variant_218087648_name._native_ptr(), 218087648)
        ...
        self._method_raw_to_base64_3999417757 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_raw_to_base64_3999417757_name._native_ptr(), 3999417757)
        ...
        self._method_base64_to_raw_659035735 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_base64_to_raw_659035735_name._native_ptr(), 659035735)
        ...
        self._method_utf8_to_base64_1703090593 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_utf8_to_base64_1703090593_name._native_ptr(), 1703090593)
        ...
        self._method_base64_to_utf8_1703090593 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_base64_to_utf8_1703090593_name._native_ptr(), 1703090593)
        assert(Marshalls._method_base64_to_utf8_1703090593 != nil)
    }

    public func variant_to_base64(variant: Variant, full_objects: UInt8) -> String {
    ...
    public func base64_to_variant(base64_str: String, allow_objects: UInt8) -> Variant {
        withUnsafePointer(to: allow_objects) { allow_objects_native in
        withUnsafePointer(to: base64_str) { base64_str_native in
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 2)
            defer { args.deallocate() }
            _ = args.initialize(from: [
    ...
    public func raw_to_base64(array: PackedByteArray) -> String {
    ...
    public func base64_to_raw(base64_str: String) -> PackedByteArray {
        withUnsafePointer(to: base64_str) { base64_str_native in
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            defer { args.deallocate() }
            _ = args.initialize(from: [
    ...
    public func utf8_to_base64(utf8_str: String) -> String {
        withUnsafePointer(to: utf8_str) { utf8_str_native in
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            defer { args.deallocate() }
            _ = args.initialize(from: [
    ...
    public func base64_to_utf8(base64_str: String) -> String {
        withUnsafePointer(to: base64_str) { base64_str_native in
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            defer { args.deallocate() }
            _ = args.initialize(from: [
