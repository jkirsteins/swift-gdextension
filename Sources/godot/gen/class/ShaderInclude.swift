...
open class ShaderInclude : Resource {
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        self._method_set_code_83702148 = self.interface.pointee.classdb_get_method_bind(__godot_name_ShaderInclude._native_ptr(), _method_set_code_83702148_name._native_ptr(), 83702148)
        assert(ShaderInclude._method_set_code_83702148 != nil)
        let _method_get_code_201670096_name = StringName(from: "get_code")
        self._method_get_code_201670096 = self.interface.pointee.classdb_get_method_bind(__godot_name_ShaderInclude._native_ptr(), _method_get_code_201670096_name._native_ptr(), 201670096)
