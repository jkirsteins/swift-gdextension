...
public class EditorProperty : Container {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_checkable_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_checkable_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_is_checkable_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_is_checkable_36873697_name._native_ptr(), 36873697)
        ...
        self._method_set_checked_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_checked_2586408642_name._native_ptr(), 2586408642)
        assert(EditorProperty._method_set_checked_2586408642 != nil)
        let _method_is_checked_36873697_name = StringName(from: "is_checked")
        self._method_is_checked_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_is_checked_36873697_name._native_ptr(), 36873697)
        ...
        self._method_set_draw_warning_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_draw_warning_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_is_draw_warning_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_is_draw_warning_36873697_name._native_ptr(), 36873697)
        ...
        self._method_set_keying_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_keying_2586408642_name._native_ptr(), 2586408642)
        assert(EditorProperty._method_set_keying_2586408642 != nil)
        let _method_is_keying_36873697_name = StringName(from: "is_keying")
        self._method_is_keying_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_is_keying_36873697_name._native_ptr(), 36873697)
        ...
        self._method_set_deletable_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_deletable_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_is_deletable_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_is_deletable_36873697_name._native_ptr(), 36873697)
        ...
        self._method_get_edited_property_2002593661 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_edited_property_2002593661_name._native_ptr(), 2002593661)
        ...
        self._method_get_edited_object_2050059866 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_edited_object_2050059866_name._native_ptr(), 2050059866)
        ...
        self._method_update_property_3218959716 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_update_property_3218959716_name._native_ptr(), 3218959716)
        ...
        self._method_add_focusable_1496901182 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_add_focusable_1496901182_name._native_ptr(), 1496901182)
        ...
        self._method_set_bottom_editor_1496901182 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_bottom_editor_1496901182_name._native_ptr(), 1496901182)
        ...
        self._method_emit_changed_3069422438 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_emit_changed_3069422438_name._native_ptr(), 3069422438)
    ...
    public func set_label(text: String)  {
