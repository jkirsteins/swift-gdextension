...
open class VisualShaderNodeExpression : VisualShaderNodeGroupBase {
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        self._method_set_expression_83702148 = self.interface.pointee.classdb_get_method_bind(__godot_name_VisualShaderNodeExpression._native_ptr(), _method_set_expression_83702148_name._native_ptr(), 83702148)
        ...
        self._method_get_expression_201670096 = self.interface.pointee.classdb_get_method_bind(__godot_name_VisualShaderNodeExpression._native_ptr(), _method_get_expression_201670096_name._native_ptr(), 201670096)
