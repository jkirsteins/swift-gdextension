...
open class AnimatableBody3D : StaticBody3D {
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        self._method_set_sync_to_physics_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name_AnimatableBody3D._native_ptr(), _method_set_sync_to_physics_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_is_sync_to_physics_enabled_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name_AnimatableBody3D._native_ptr(), _method_is_sync_to_physics_enabled_36873697_name._native_ptr(), 36873697)
