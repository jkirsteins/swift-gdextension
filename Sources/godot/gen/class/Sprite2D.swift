...
open class Sprite2D : Node2D {
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        self._method_set_texture_4051416890 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_set_texture_4051416890_name._native_ptr(), 4051416890)
        assert(Sprite2D._method_set_texture_4051416890 != nil)
        let _method_get_texture_3635182373_name = StringName(from: "get_texture")
        self._method_get_texture_3635182373 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_get_texture_3635182373_name._native_ptr(), 3635182373)
        assert(Sprite2D._method_get_texture_3635182373 != nil)
        let _method_set_centered_2586408642_name = StringName(from: "set_centered")
        self._method_set_centered_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_set_centered_2586408642_name._native_ptr(), 2586408642)
        assert(Sprite2D._method_set_centered_2586408642 != nil)
        let _method_is_centered_36873697_name = StringName(from: "is_centered")
        self._method_is_centered_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_is_centered_36873697_name._native_ptr(), 36873697)
        assert(Sprite2D._method_is_centered_36873697 != nil)
        let _method_set_offset_743155724_name = StringName(from: "set_offset")
        self._method_set_offset_743155724 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_set_offset_743155724_name._native_ptr(), 743155724)
        assert(Sprite2D._method_set_offset_743155724 != nil)
        let _method_get_offset_3341600327_name = StringName(from: "get_offset")
        self._method_get_offset_3341600327 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_get_offset_3341600327_name._native_ptr(), 3341600327)
        assert(Sprite2D._method_get_offset_3341600327 != nil)
        let _method_set_flip_h_2586408642_name = StringName(from: "set_flip_h")
        self._method_set_flip_h_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_set_flip_h_2586408642_name._native_ptr(), 2586408642)
        assert(Sprite2D._method_set_flip_h_2586408642 != nil)
        let _method_is_flipped_h_36873697_name = StringName(from: "is_flipped_h")
        self._method_is_flipped_h_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_is_flipped_h_36873697_name._native_ptr(), 36873697)
        assert(Sprite2D._method_is_flipped_h_36873697 != nil)
        let _method_set_flip_v_2586408642_name = StringName(from: "set_flip_v")
        self._method_set_flip_v_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_set_flip_v_2586408642_name._native_ptr(), 2586408642)
        assert(Sprite2D._method_set_flip_v_2586408642 != nil)
        let _method_is_flipped_v_36873697_name = StringName(from: "is_flipped_v")
        self._method_is_flipped_v_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_is_flipped_v_36873697_name._native_ptr(), 36873697)
        ...
        self._method_set_region_enabled_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_set_region_enabled_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_is_region_enabled_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_is_region_enabled_36873697_name._native_ptr(), 36873697)
        ...
        self._method_is_pixel_opaque_556197845 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_is_pixel_opaque_556197845_name._native_ptr(), 556197845)
        ...
        self._method_set_region_rect_2046264180 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_set_region_rect_2046264180_name._native_ptr(), 2046264180)
        ...
        self._method_get_region_rect_1639390495 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_get_region_rect_1639390495_name._native_ptr(), 1639390495)
        ...
        self._method_set_region_filter_clip_enabled_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_set_region_filter_clip_enabled_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_is_region_filter_clip_enabled_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_is_region_filter_clip_enabled_36873697_name._native_ptr(), 36873697)
        ...
        self._method_set_frame_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_set_frame_1286410249_name._native_ptr(), 1286410249)
        assert(Sprite2D._method_set_frame_1286410249 != nil)
        let _method_get_frame_3905245786_name = StringName(from: "get_frame")
        self._method_get_frame_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_get_frame_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_set_frame_coords_1130785943 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_set_frame_coords_1130785943_name._native_ptr(), 1130785943)
        ...
        self._method_get_frame_coords_3690982128 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_get_frame_coords_3690982128_name._native_ptr(), 3690982128)
        ...
        self._method_set_vframes_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_set_vframes_1286410249_name._native_ptr(), 1286410249)
        assert(Sprite2D._method_set_vframes_1286410249 != nil)
        let _method_get_vframes_3905245786_name = StringName(from: "get_vframes")
        self._method_get_vframes_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_get_vframes_3905245786_name._native_ptr(), 3905245786)
        assert(Sprite2D._method_get_vframes_3905245786 != nil)
        let _method_set_hframes_1286410249_name = StringName(from: "set_hframes")
        self._method_set_hframes_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_set_hframes_1286410249_name._native_ptr(), 1286410249)
        assert(Sprite2D._method_set_hframes_1286410249 != nil)
        let _method_get_hframes_3905245786_name = StringName(from: "get_hframes")
        self._method_get_hframes_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_get_hframes_3905245786_name._native_ptr(), 3905245786)
        assert(Sprite2D._method_get_hframes_3905245786 != nil)
        let _method_get_rect_1639390495_name = StringName(from: "get_rect")
        self._method_get_rect_1639390495 = self.interface.pointee.classdb_get_method_bind(__godot_name_Sprite2D._native_ptr(), _method_get_rect_1639390495_name._native_ptr(), 1639390495)
