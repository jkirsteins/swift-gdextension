...
open class Sprite2D : Node2D {
    ...
    static var _method_is_pixel_opaque_556197845: StringName! = nil
    static var _method_set_region_rect_2046264180: StringName! = nil
    static var _method_get_region_rect_1639390495: StringName! = nil
    static var _method_set_region_filter_clip_enabled_2586408642: StringName! = nil
    static var _method_is_region_filter_clip_enabled_36873697: StringName! = nil
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        assert(__godot_name_Sprite2D == nil)
        ...
        self._method_is_pixel_opaque_556197845 = StringName(from: "is_pixel_opaque")
        assert(self._method_is_pixel_opaque_556197845 != nil)
        ...
        self._method_set_region_filter_clip_enabled_2586408642 = StringName(from: "set_region_filter_clip_enabled")
        assert(self._method_set_region_filter_clip_enabled_2586408642 != nil)
        self._method_is_region_filter_clip_enabled_36873697 = StringName(from: "is_region_filter_clip_enabled")
        assert(self._method_is_region_filter_clip_enabled_36873697 != nil)
    ...
    public func is_pixel_opaque(pos: Vector2) -> UInt8 {
        ...
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            ...
            let _mbinding = self.interface.pointee.classdb_get_method_bind(
                    Self.__godot_name._native_ptr(),
                    Self._method_is_pixel_opaque_556197845._native_ptr(),
                    556197845)
                assert(_mbinding != nil)
                self.interface.pointee.object_method_bind_ptrcall(
                    _mbinding,
    ...
    public func set_region_filter_clip_enabled(enabled: UInt8)  {
        ...
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            ...
            let _mbinding = self.interface.pointee.classdb_get_method_bind(
                    Self.__godot_name._native_ptr(),
                    Self._method_set_region_filter_clip_enabled_2586408642._native_ptr(),
                    2586408642)
                assert(_mbinding != nil)
                self.interface.pointee.object_method_bind_ptrcall(
                    _mbinding,
    ...
    public func is_region_filter_clip_enabled() -> UInt8 {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            let _mbinding = self.interface.pointee.classdb_get_method_bind(
                    Self.__godot_name._native_ptr(),
                    Self._method_is_region_filter_clip_enabled_36873697._native_ptr(),
                    36873697)
                assert(_mbinding != nil)
                self.interface.pointee.object_method_bind_ptrcall(
                    _mbinding,
