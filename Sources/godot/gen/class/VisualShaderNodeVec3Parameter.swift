...
open class VisualShaderNodeVec3Parameter : VisualShaderNodeParameter {
    ...
    static var _method_set_default_value_3460891852: StringName! = nil
    static var _method_get_default_value_3360562783: StringName! = nil
    
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        
        guard p_level == GDEXTENSION_INITIALIZATION_SCENE else { return }

        assert(__godot_name_VisualShaderNodeVec3Parameter == nil)
        ...
        self._method_set_default_value_3460891852 = StringName(from: "set_default_value")
        assert(self._method_set_default_value_3460891852 != nil)
        self._method_get_default_value_3360562783 = StringName(from: "get_default_value")
        assert(self._method_get_default_value_3360562783 != nil)
    }
    ...
    public func set_default_value(value: Vector3)  {
        ...
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            ...
            let _mbinding = self.interface.pointee.classdb_get_method_bind(
                    Self.__godot_name._native_ptr(),
                    Self._method_set_default_value_3460891852._native_ptr(),
                    3460891852)
                assert(_mbinding != nil)
                self.interface.pointee.object_method_bind_ptrcall(
                    _mbinding,
    ...
    public func get_default_value() -> Vector3 {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            let _mbinding = self.interface.pointee.classdb_get_method_bind(
                    Self.__godot_name._native_ptr(),
                    Self._method_get_default_value_3360562783._native_ptr(),
                    3360562783)
                assert(_mbinding != nil)
                self.interface.pointee.object_method_bind_ptrcall(
                    _mbinding,
