...
open class VisualInstance3D : Node3D {
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        self._method_set_base_2722037293 = self.interface.pointee.classdb_get_method_bind(__godot_name_VisualInstance3D._native_ptr(), _method_set_base_2722037293_name._native_ptr(), 2722037293)
        assert(VisualInstance3D._method_set_base_2722037293 != nil)
        let _method_get_base_2944877500_name = StringName(from: "get_base")
        self._method_get_base_2944877500 = self.interface.pointee.classdb_get_method_bind(__godot_name_VisualInstance3D._native_ptr(), _method_get_base_2944877500_name._native_ptr(), 2944877500)
        ...
        self._method_get_instance_2944877500 = self.interface.pointee.classdb_get_method_bind(__godot_name_VisualInstance3D._native_ptr(), _method_get_instance_2944877500_name._native_ptr(), 2944877500)
        ...
        self._method_set_layer_mask_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name_VisualInstance3D._native_ptr(), _method_set_layer_mask_1286410249_name._native_ptr(), 1286410249)
        ...
        self._method_get_layer_mask_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name_VisualInstance3D._native_ptr(), _method_get_layer_mask_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_set_layer_mask_value_300928843 = self.interface.pointee.classdb_get_method_bind(__godot_name_VisualInstance3D._native_ptr(), _method_set_layer_mask_value_300928843_name._native_ptr(), 300928843)
        ...
        self._method_get_layer_mask_value_1116898809 = self.interface.pointee.classdb_get_method_bind(__godot_name_VisualInstance3D._native_ptr(), _method_get_layer_mask_value_1116898809_name._native_ptr(), 1116898809)
        ...
        self._method_set_sorting_offset_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name_VisualInstance3D._native_ptr(), _method_set_sorting_offset_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_sorting_offset_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name_VisualInstance3D._native_ptr(), _method_get_sorting_offset_1740695150_name._native_ptr(), 1740695150)
        ...
        self._method_set_sorting_use_aabb_center_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name_VisualInstance3D._native_ptr(), _method_set_sorting_use_aabb_center_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_is_sorting_use_aabb_center_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name_VisualInstance3D._native_ptr(), _method_is_sorting_use_aabb_center_36873697_name._native_ptr(), 36873697)
        ...
        self._method_get_aabb_1068685055 = self.interface.pointee.classdb_get_method_bind(__godot_name_VisualInstance3D._native_ptr(), _method_get_aabb_1068685055_name._native_ptr(), 1068685055)
