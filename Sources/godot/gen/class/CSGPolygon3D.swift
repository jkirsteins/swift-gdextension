...
open class CSGPolygon3D : CSGPrimitive3D {
    ...
    public func get_mode() -> CSGPolygon3D.Mode {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return CSGPolygon3D.Mode(godot: __resPtr.pointee)
    }
    ...
    public func get_path_interval_type() -> CSGPolygon3D.PathIntervalType {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return CSGPolygon3D.PathIntervalType(godot: __resPtr.pointee)
    }
    ...
    public func get_path_rotation() -> CSGPolygon3D.PathRotation {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return CSGPolygon3D.PathRotation(godot: __resPtr.pointee)
    }
