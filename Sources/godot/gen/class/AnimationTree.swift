...
public class AnimationTree : Node {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_tree_root_712869711 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_tree_root_712869711_name._native_ptr(), 712869711)
        ...
        self._method_get_tree_root_1462070895 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_tree_root_1462070895_name._native_ptr(), 1462070895)
        ...
        self._method_set_process_callback_1723352826 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_process_callback_1723352826_name._native_ptr(), 1723352826)
        ...
        self._method_get_process_callback_891317132 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_process_callback_891317132_name._native_ptr(), 891317132)
        ...
        self._method_set_animation_player_1348162250 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_animation_player_1348162250_name._native_ptr(), 1348162250)
        ...
        self._method_get_animation_player_4075236667 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_animation_player_4075236667_name._native_ptr(), 4075236667)
        ...
        self._method_set_advance_expression_base_node_1348162250 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_advance_expression_base_node_1348162250_name._native_ptr(), 1348162250)
        ...
        self._method_get_advance_expression_base_node_4075236667 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_advance_expression_base_node_4075236667_name._native_ptr(), 4075236667)
        ...
        self._method_set_root_motion_track_1348162250 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_root_motion_track_1348162250_name._native_ptr(), 1348162250)
        ...
        self._method_get_root_motion_track_4075236667 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_root_motion_track_4075236667_name._native_ptr(), 4075236667)
        ...
        self._method_get_root_motion_position_3360562783 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_root_motion_position_3360562783_name._native_ptr(), 3360562783)
        ...
        self._method_get_root_motion_rotation_1222331677 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_root_motion_rotation_1222331677_name._native_ptr(), 1222331677)
        ...
        self._method_get_root_motion_scale_3360562783 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_root_motion_scale_3360562783_name._native_ptr(), 3360562783)
        ...
        self._method_rename_parameter_3186203200 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_rename_parameter_3186203200_name._native_ptr(), 3186203200)
    ...
    public func get_process_callback() -> AnimationTree.AnimationProcessCallback {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return AnimationTree.AnimationProcessCallback(from: __resPtr.pointee)
    }
    ...
    public func rename_parameter(old_name: String, new_name: String)  {
        withUnsafePointer(to: new_name) { new_name_native in
        withUnsafePointer(to: old_name) { old_name_native in
