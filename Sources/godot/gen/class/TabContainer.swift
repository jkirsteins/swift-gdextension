...
public class TabContainer : Container {
    ...
    public override class func initialize_class() {
        ...
        self._method_get_current_tab_control_2783021301 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_current_tab_control_2783021301_name._native_ptr(), 2783021301)
        ...
        self._method_get_tab_control_1065994134 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_tab_control_1065994134_name._native_ptr(), 1065994134)
        ...
        self._method_set_tabs_visible_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_tabs_visible_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_are_tabs_visible_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_are_tabs_visible_36873697_name._native_ptr(), 36873697)
        ...
        self._method_set_all_tabs_in_front_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_all_tabs_in_front_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_is_all_tabs_in_front_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_is_all_tabs_in_front_36873697_name._native_ptr(), 36873697)
        ...
        self._method_get_tab_idx_from_control_2787397975 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_tab_idx_from_control_2787397975_name._native_ptr(), 2787397975)
        ...
        self._method_set_popup_1078189570 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_popup_1078189570_name._native_ptr(), 1078189570)
        assert(TabContainer._method_set_popup_1078189570 != nil)
        let _method_get_popup_111095082_name = StringName(from: "get_popup")
        self._method_get_popup_111095082 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_popup_111095082_name._native_ptr(), 111095082)
        ...
        self._method_set_use_hidden_tabs_for_min_size_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_use_hidden_tabs_for_min_size_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_get_use_hidden_tabs_for_min_size_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_use_hidden_tabs_for_min_size_36873697_name._native_ptr(), 36873697)
    ...
    public func get_popup() -> Popup {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return Popup(from: __resPtr.pointee)
    }
