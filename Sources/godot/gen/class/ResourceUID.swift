...
public class ResourceUID : Object {
    ...
    public override class func initialize_class() {
        ...
        self._method_id_to_text_844755477 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_id_to_text_844755477_name._native_ptr(), 844755477)
        assert(ResourceUID._method_id_to_text_844755477 != nil)
        let _method_text_to_id_1321353865_name = StringName(from: "text_to_id")
        self._method_text_to_id_1321353865 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_text_to_id_1321353865_name._native_ptr(), 1321353865)
        assert(ResourceUID._method_text_to_id_1321353865 != nil)
        let _method_create_id_2455072627_name = StringName(from: "create_id")
        self._method_create_id_2455072627 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_create_id_2455072627_name._native_ptr(), 2455072627)
        assert(ResourceUID._method_create_id_2455072627 != nil)
        let _method_has_id_1116898809_name = StringName(from: "has_id")
        self._method_has_id_1116898809 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_has_id_1116898809_name._native_ptr(), 1116898809)
        assert(ResourceUID._method_has_id_1116898809 != nil)
        let _method_add_id_501894301_name = StringName(from: "add_id")
        self._method_add_id_501894301 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_add_id_501894301_name._native_ptr(), 501894301)
        assert(ResourceUID._method_add_id_501894301 != nil)
        let _method_set_id_501894301_name = StringName(from: "set_id")
        self._method_set_id_501894301 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_id_501894301_name._native_ptr(), 501894301)
        assert(ResourceUID._method_set_id_501894301 != nil)
        let _method_get_id_path_844755477_name = StringName(from: "get_id_path")
        self._method_get_id_path_844755477 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_id_path_844755477_name._native_ptr(), 844755477)
        assert(ResourceUID._method_get_id_path_844755477 != nil)
        let _method_remove_id_1286410249_name = StringName(from: "remove_id")
        self._method_remove_id_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_remove_id_1286410249_name._native_ptr(), 1286410249)
        assert(ResourceUID._method_remove_id_1286410249 != nil)
    }

    public func id_to_text(id: Int64) -> String {
    ...
    public func text_to_id(text_id: String) -> Int64 {
        withUnsafePointer(to: text_id) { text_id_native in
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            defer { args.deallocate() }
            _ = args.initialize(from: [
                .init(text_id_native)
    ...
    public func add_id(id: Int64, path: String)  {
    ...
    public func set_id(id: Int64, path: String)  {
        withUnsafePointer(to: path) { path_native in
        withUnsafePointer(to: id) { id_native in
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 2)
            defer { args.deallocate() }
    ...
    public func get_id_path(id: Int64) -> String {
        withUnsafePointer(to: id) { id_native in
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            defer { args.deallocate() }
            _ = args.initialize(from: [
