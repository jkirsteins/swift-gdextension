...
public class Skin : Resource {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_bind_count_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_bind_count_1286410249_name._native_ptr(), 1286410249)
        ...
        self._method_get_bind_count_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_bind_count_3905245786_name._native_ptr(), 3905245786)
        assert(Skin._method_get_bind_count_3905245786 != nil)
        let _method_add_bind_3616898986_name = StringName(from: "add_bind")
        self._method_add_bind_3616898986 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_add_bind_3616898986_name._native_ptr(), 3616898986)
        assert(Skin._method_add_bind_3616898986 != nil)
        let _method_add_named_bind_3154712474_name = StringName(from: "add_named_bind")
        self._method_add_named_bind_3154712474 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_add_named_bind_3154712474_name._native_ptr(), 3154712474)
        assert(Skin._method_add_named_bind_3154712474 != nil)
        let _method_set_bind_pose_3616898986_name = StringName(from: "set_bind_pose")
        self._method_set_bind_pose_3616898986 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_bind_pose_3616898986_name._native_ptr(), 3616898986)
        assert(Skin._method_set_bind_pose_3616898986 != nil)
        let _method_get_bind_pose_1965739696_name = StringName(from: "get_bind_pose")
        self._method_get_bind_pose_1965739696 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_bind_pose_1965739696_name._native_ptr(), 1965739696)
        assert(Skin._method_get_bind_pose_1965739696 != nil)
        let _method_set_bind_name_3780747571_name = StringName(from: "set_bind_name")
        self._method_set_bind_name_3780747571 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_bind_name_3780747571_name._native_ptr(), 3780747571)
        assert(Skin._method_set_bind_name_3780747571 != nil)
        let _method_get_bind_name_659327637_name = StringName(from: "get_bind_name")
        self._method_get_bind_name_659327637 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_bind_name_659327637_name._native_ptr(), 659327637)
        assert(Skin._method_get_bind_name_659327637 != nil)
        let _method_set_bind_bone_3937882851_name = StringName(from: "set_bind_bone")
        self._method_set_bind_bone_3937882851 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_bind_bone_3937882851_name._native_ptr(), 3937882851)
        assert(Skin._method_set_bind_bone_3937882851 != nil)
        let _method_get_bind_bone_923996154_name = StringName(from: "get_bind_bone")
        self._method_get_bind_bone_923996154 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_bind_bone_923996154_name._native_ptr(), 923996154)
        assert(Skin._method_get_bind_bone_923996154 != nil)
        let _method_clear_binds_3218959716_name = StringName(from: "clear_binds")
        self._method_clear_binds_3218959716 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_clear_binds_3218959716_name._native_ptr(), 3218959716)
    ...
    public func add_named_bind(name: String, pose: Transform3D)  {
