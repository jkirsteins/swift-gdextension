...
public class Node : Object {
    ...
    public func add_sibling(sibling: Node, force_readable_name: Bool)  {
        ...
        defer { args.deallocate() }
        _ = args.initialize(from: [
            .init(sibling._native_ptr()), .init(force_readable_name._native_ptr())
        ])
    }
    ...
    public func add_child(node: Node, force_readable_name: Bool, internal: Node.InternalMode)  {
        ...
        defer { args.deallocate() }
        _ = args.initialize(from: [
            .init(node._native_ptr()), .init(force_readable_name._native_ptr()), .init(internal._native_ptr())
        ])
    }
    ...
    public func reparent(new_parent: Node, keep_global_transform: Bool)  {
        ...
        defer { args.deallocate() }
        _ = args.initialize(from: [
            .init(new_parent._native_ptr()), .init(keep_global_transform._native_ptr())
        ])
    }
    public func get_child_count(include_internal: Bool)  -> Int64 {
        ...
        defer { args.deallocate() }
        _ = args.initialize(from: [
            .init(include_internal._native_ptr())
        ])
    }
    public func get_children(include_internal: Bool)  -> typedarray::Node {
    ...
    public func get_child(idx: Int64, include_internal: Bool)  -> Node {
        ...
        defer { args.deallocate() }
        _ = args.initialize(from: [
            .init(idx._native_ptr()), .init(include_internal._native_ptr())
        ])
    }
    ...
    public func find_child(pattern: String, recursive: Bool, owned: Bool)  -> Node {
        ...
        defer { args.deallocate() }
        _ = args.initialize(from: [
            pattern_nativeStr, .init(recursive._native_ptr()), .init(owned._native_ptr())
        ])
    }
    public func find_children(pattern: String, type: String, recursive: Bool, owned: Bool)  -> typedarray::Node {
        let pattern_nativeStr = pattern._create_native__kept()
        defer { pattern_nativeStr.deallocate() }
        ...
        defer { args.deallocate() }
        _ = args.initialize(from: [
            pattern_nativeStr, type_nativeStr, .init(recursive._native_ptr()), .init(owned._native_ptr())
        ])
    }
    ...
    public func get_path_to(node: Node, use_unique_path: Bool)  -> NodePath {
        ...
        defer { args.deallocate() }
        _ = args.initialize(from: [
            .init(node._native_ptr()), .init(use_unique_path._native_ptr())
        ])
    }
    public func add_to_group(group: StringName, persistent: Bool)  {
        ...
        defer { args.deallocate() }
        _ = args.initialize(from: [
            .init(group._native_ptr()), .init(persistent._native_ptr())
        ])
    }
    ...
    public func move_child(child_node: Node, to_index: Int64)  {
        ...
        defer { args.deallocate() }
        _ = args.initialize(from: [
            .init(child_node._native_ptr()), .init(to_index._native_ptr())
        ])
    }
    public func get_groups()  -> typedarray::StringName {
    ...
    public func propagate_call(method: StringName, args: Array, parent_first: Bool)  {
        ...
        defer { args.deallocate() }
        _ = args.initialize(from: [
            .init(method._native_ptr()), .init(args._native_ptr()), .init(parent_first._native_ptr())
        ])
    }
    ...
    public func replace_by(node: Node, keep_groups: Bool)  {
        ...
        defer { args.deallocate() }
        _ = args.initialize(from: [
            .init(node._native_ptr()), .init(keep_groups._native_ptr())
        ])
    }
    public func set_scene_instance_load_placeholder(load_placeholder: Bool)  {
        ...
        defer { args.deallocate() }
        _ = args.initialize(from: [
            .init(load_placeholder._native_ptr())
        ])
    }
    ...
    public func set_editable_instance(node: Node, is_editable: Bool)  {
        ...
        defer { args.deallocate() }
        _ = args.initialize(from: [
            .init(node._native_ptr()), .init(is_editable._native_ptr())
        ])
    }
    ...
    public func set_multiplayer_authority(id: Int64, recursive: Bool)  {
        ...
        defer { args.deallocate() }
        _ = args.initialize(from: [
            .init(id._native_ptr()), .init(recursive._native_ptr())
        ])
    }
    ...
    public func rpc_id(peer_id: Int64, method: StringName)  -> Error {
        ...
        defer { args.deallocate() }
        _ = args.initialize(from: [
            .init(peer_id._native_ptr()), .init(method._native_ptr())
        ])
    }
