...
public class Noise : Resource {
    ...
    public override class func initialize_class() {
        ...
        self._method_get_noise_1d_3919130443 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_noise_1d_3919130443_name._native_ptr(), 3919130443)
        assert(Noise._method_get_noise_1d_3919130443 != nil)
        let _method_get_noise_2d_2753205203_name = StringName(from: "get_noise_2d")
        self._method_get_noise_2d_2753205203 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_noise_2d_2753205203_name._native_ptr(), 2753205203)
        assert(Noise._method_get_noise_2d_2753205203 != nil)
        let _method_get_noise_2dv_2276447920_name = StringName(from: "get_noise_2dv")
        self._method_get_noise_2dv_2276447920 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_noise_2dv_2276447920_name._native_ptr(), 2276447920)
        assert(Noise._method_get_noise_2dv_2276447920 != nil)
        let _method_get_noise_3d_973811851_name = StringName(from: "get_noise_3d")
        self._method_get_noise_3d_973811851 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_noise_3d_973811851_name._native_ptr(), 973811851)
        assert(Noise._method_get_noise_3d_973811851 != nil)
        let _method_get_noise_3dv_1109078154_name = StringName(from: "get_noise_3dv")
        self._method_get_noise_3dv_1109078154 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_noise_3dv_1109078154_name._native_ptr(), 1109078154)
        assert(Noise._method_get_noise_3dv_1109078154 != nil)
        let _method_get_image_2569233413_name = StringName(from: "get_image")
        self._method_get_image_2569233413 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_image_2569233413_name._native_ptr(), 2569233413)
        ...
        self._method_get_seamless_image_2210827790 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_seamless_image_2210827790_name._native_ptr(), 2210827790)
