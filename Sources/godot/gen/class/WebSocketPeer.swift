...
public class WebSocketPeer : PacketPeer {
    ...
    public override class func initialize_class() {
        ...
        self._method_connect_to_url_3097527179 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_connect_to_url_3097527179_name._native_ptr(), 3097527179)
        ...
        self._method_accept_stream_255125695 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_accept_stream_255125695_name._native_ptr(), 255125695)
        assert(WebSocketPeer._method_accept_stream_255125695 != nil)
        let _method_send_3440492527_name = StringName(from: "send")
        self._method_send_3440492527 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_send_3440492527_name._native_ptr(), 3440492527)
        assert(WebSocketPeer._method_send_3440492527 != nil)
        let _method_send_text_166001499_name = StringName(from: "send_text")
        self._method_send_text_166001499 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_send_text_166001499_name._native_ptr(), 166001499)
        ...
        self._method_was_string_packet_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_was_string_packet_36873697_name._native_ptr(), 36873697)
        ...
        self._method_close_1047156615 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_close_1047156615_name._native_ptr(), 1047156615)
        ...
        self._method_get_selected_protocol_201670096 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_selected_protocol_201670096_name._native_ptr(), 201670096)
        ...
        self._method_get_requested_url_201670096 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_requested_url_201670096_name._native_ptr(), 201670096)
        ...
        self._method_get_current_outbound_buffered_amount_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_current_outbound_buffered_amount_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_get_ready_state_346482985 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_ready_state_346482985_name._native_ptr(), 346482985)
        ...
        self._method_get_close_code_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_close_code_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_get_close_reason_201670096 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_close_reason_201670096_name._native_ptr(), 201670096)
    ...
    public func connect_to_url(url: String, tls_client_options: TLSOptions) -> Error {
    ...
    public func send_text(message: String) -> Error {
    ...
    public func close(code: Int64, reason: String)  {
        withUnsafePointer(to: reason) { reason_native in
    ...
    public func get_selected_protocol() -> String {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            defer { args.deallocate() }
            _ = args.initialize(from: [
    ...
    public func get_requested_url() -> String {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            defer { args.deallocate() }
            _ = args.initialize(from: [
    ...
    public func get_ready_state() -> WebSocketPeer.State {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return WebSocketPeer.State(from: __resPtr.pointee)
    }
    ...
    public func get_close_reason() -> String {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            defer { args.deallocate() }
            _ = args.initialize(from: [
