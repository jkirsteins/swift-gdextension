...
public class VoxelGIData : Resource {
    ...
    public override class func initialize_class() {
        ...
        self._method_allocate_4041601946 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_allocate_4041601946_name._native_ptr(), 4041601946)
        assert(VoxelGIData._method_allocate_4041601946 != nil)
        let _method_get_bounds_1068685055_name = StringName(from: "get_bounds")
        self._method_get_bounds_1068685055 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_bounds_1068685055_name._native_ptr(), 1068685055)
        ...
        self._method_get_octree_size_3360562783 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_octree_size_3360562783_name._native_ptr(), 3360562783)
        ...
        self._method_get_to_cell_xform_3229777777 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_to_cell_xform_3229777777_name._native_ptr(), 3229777777)
        ...
        self._method_get_octree_cells_2362200018 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_octree_cells_2362200018_name._native_ptr(), 2362200018)
        ...
        self._method_get_data_cells_2362200018 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_data_cells_2362200018_name._native_ptr(), 2362200018)
        ...
        self._method_get_level_counts_1930428628 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_level_counts_1930428628_name._native_ptr(), 1930428628)
        ...
        self._method_set_dynamic_range_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_dynamic_range_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_dynamic_range_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_dynamic_range_1740695150_name._native_ptr(), 1740695150)
        ...
        self._method_set_normal_bias_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_normal_bias_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_normal_bias_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_normal_bias_1740695150_name._native_ptr(), 1740695150)
        ...
        self._method_set_propagation_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_propagation_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_propagation_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_propagation_1740695150_name._native_ptr(), 1740695150)
        ...
        self._method_set_use_two_bounces_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_use_two_bounces_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_is_using_two_bounces_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_is_using_two_bounces_36873697_name._native_ptr(), 36873697)
