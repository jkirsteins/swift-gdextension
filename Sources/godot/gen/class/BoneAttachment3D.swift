...
public class BoneAttachment3D : Node3D {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_bone_name_83702148 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_bone_name_83702148_name._native_ptr(), 83702148)
        ...
        self._method_get_bone_name_201670096 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_bone_name_201670096_name._native_ptr(), 201670096)
        ...
        self._method_set_bone_idx_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_bone_idx_1286410249_name._native_ptr(), 1286410249)
        ...
        self._method_get_bone_idx_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_bone_idx_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_on_bone_pose_update_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_on_bone_pose_update_1286410249_name._native_ptr(), 1286410249)
        ...
        self._method_set_override_pose_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_override_pose_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_get_override_pose_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_override_pose_36873697_name._native_ptr(), 36873697)
        ...
        self._method_set_use_external_skeleton_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_use_external_skeleton_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_get_use_external_skeleton_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_use_external_skeleton_36873697_name._native_ptr(), 36873697)
        ...
        self._method_set_external_skeleton_1348162250 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_external_skeleton_1348162250_name._native_ptr(), 1348162250)
        ...
        self._method_get_external_skeleton_4075236667 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_external_skeleton_4075236667_name._native_ptr(), 4075236667)
        assert(BoneAttachment3D._method_get_external_skeleton_4075236667 != nil)
    }

    public func set_bone_name(bone_name: String)  {
        withUnsafePointer(to: bone_name) { bone_name_native in
    ...
    public func get_bone_name() -> String {
