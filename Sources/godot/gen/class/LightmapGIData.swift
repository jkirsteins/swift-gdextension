...
public class LightmapGIData : Resource {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_light_texture_1278366092 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_light_texture_1278366092_name._native_ptr(), 1278366092)
        ...
        self._method_get_light_texture_3984243839 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_light_texture_3984243839_name._native_ptr(), 3984243839)
        ...
        self._method_set_uses_spherical_harmonics_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_uses_spherical_harmonics_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_is_using_spherical_harmonics_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_is_using_spherical_harmonics_36873697_name._native_ptr(), 36873697)
        ...
        self._method_add_user_4272570515 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_add_user_4272570515_name._native_ptr(), 4272570515)
        ...
        self._method_get_user_count_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_user_count_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_get_user_path_408788394 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_user_path_408788394_name._native_ptr(), 408788394)
        ...
        self._method_clear_users_3218959716 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_clear_users_3218959716_name._native_ptr(), 3218959716)
    ...
    public func get_light_texture() -> TextureLayered {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return TextureLayered(from: __resPtr.pointee)
    }
