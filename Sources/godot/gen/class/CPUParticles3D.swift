...
public class CPUParticles3D : GeometryInstance3D {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_draw_order_1427401774 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_draw_order_1427401774_name._native_ptr(), 1427401774)
        ...
        self._method_get_draw_order_1321900776 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_draw_order_1321900776_name._native_ptr(), 1321900776)
        ...
        self._method_set_param_min_557936109 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_param_min_557936109_name._native_ptr(), 557936109)
        ...
        self._method_get_param_min_597646162 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_param_min_597646162_name._native_ptr(), 597646162)
        ...
        self._method_set_param_max_557936109 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_param_max_557936109_name._native_ptr(), 557936109)
        ...
        self._method_get_param_max_597646162 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_param_max_597646162_name._native_ptr(), 597646162)
        ...
        self._method_set_param_curve_4044142537 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_param_curve_4044142537_name._native_ptr(), 4044142537)
        ...
        self._method_get_param_curve_4132790277 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_param_curve_4132790277_name._native_ptr(), 4132790277)
        ...
        self._method_set_particle_flag_3515406498 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_particle_flag_3515406498_name._native_ptr(), 3515406498)
        ...
        self._method_get_particle_flag_2845201987 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_particle_flag_2845201987_name._native_ptr(), 2845201987)
        ...
        self._method_set_emission_shape_491823814 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_emission_shape_491823814_name._native_ptr(), 491823814)
        ...
        self._method_get_emission_shape_2961454842 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_emission_shape_2961454842_name._native_ptr(), 2961454842)
        ...
        self._method_set_emission_points_334873810 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_emission_points_334873810_name._native_ptr(), 334873810)
        ...
        self._method_get_emission_points_497664490 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_emission_points_497664490_name._native_ptr(), 497664490)
        ...
        self._method_set_emission_normals_334873810 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_emission_normals_334873810_name._native_ptr(), 334873810)
        ...
        self._method_get_emission_normals_497664490 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_emission_normals_497664490_name._native_ptr(), 497664490)
        ...
        self._method_get_scale_curve_z_2460114913 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_scale_curve_z_2460114913_name._native_ptr(), 2460114913)
        ...
        self._method_set_scale_curve_z_270443179 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_scale_curve_z_270443179_name._native_ptr(), 270443179)
    ...
    public func get_draw_order() -> CPUParticles3D.DrawOrder {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return CPUParticles3D.DrawOrder(from: __resPtr.pointee)
    }
    ...
    public func get_emission_shape() -> CPUParticles3D.EmissionShape {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return CPUParticles3D.EmissionShape(from: __resPtr.pointee)
    }
