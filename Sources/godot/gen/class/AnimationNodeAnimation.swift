...
public class AnimationNodeAnimation : AnimationRootNode {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_play_mode_3347718873 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_play_mode_3347718873_name._native_ptr(), 3347718873)
        ...
        self._method_get_play_mode_2061244637 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_play_mode_2061244637_name._native_ptr(), 2061244637)
    ...
    public func get_play_mode() -> AnimationNodeAnimation.PlayMode {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return AnimationNodeAnimation.PlayMode(from: __resPtr.pointee)
    }
}