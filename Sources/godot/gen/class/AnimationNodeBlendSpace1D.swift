...
public class AnimationNodeBlendSpace1D : AnimationRootNode {
    ...
    public override class func initialize_class() {
        ...
        self._method_add_blend_point_4069484420 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_add_blend_point_4069484420_name._native_ptr(), 4069484420)
        ...
        self._method_set_blend_point_position_1602489585 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_blend_point_position_1602489585_name._native_ptr(), 1602489585)
        ...
        self._method_get_blend_point_position_2339986948 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_blend_point_position_2339986948_name._native_ptr(), 2339986948)
        ...
        self._method_set_min_space_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_min_space_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_min_space_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_min_space_1740695150_name._native_ptr(), 1740695150)
        ...
        self._method_set_max_space_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_max_space_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_max_space_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_max_space_1740695150_name._native_ptr(), 1740695150)
        ...
        self._method_set_value_label_83702148 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_value_label_83702148_name._native_ptr(), 83702148)
        ...
        self._method_get_value_label_201670096 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_value_label_201670096_name._native_ptr(), 201670096)
        ...
        self._method_set_blend_mode_2600869457 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_blend_mode_2600869457_name._native_ptr(), 2600869457)
        ...
        self._method_get_blend_mode_1547667849 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_blend_mode_1547667849_name._native_ptr(), 1547667849)
    ...
    public func set_value_label(text: String)  {
    ...
    public func get_value_label() -> String {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            defer { args.deallocate() }
            _ = args.initialize(from: [
    ...
    public func get_blend_mode() -> AnimationNodeBlendSpace1D.BlendMode {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return AnimationNodeBlendSpace1D.BlendMode(from: __resPtr.pointee)
    }
