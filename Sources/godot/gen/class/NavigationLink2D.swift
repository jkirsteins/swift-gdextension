...
open class NavigationLink2D : Node2D {
    ...
    static var _method_set_end_position_743155724: StringName! = nil
    static var _method_get_end_position_3341600327: StringName! = nil
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        assert(__godot_name_NavigationLink2D == nil)
        ...
        self._method_set_end_position_743155724 = StringName(from: "set_end_position")
        assert(self._method_set_end_position_743155724 != nil)
        self._method_get_end_position_3341600327 = StringName(from: "get_end_position")
        assert(self._method_get_end_position_3341600327 != nil)
    ...
    public func set_end_position(position: Vector2)  {
        ...
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            ...
            let _mbinding = self.interface.pointee.classdb_get_method_bind(
                    Self.__godot_name._native_ptr(),
                    Self._method_set_end_position_743155724._native_ptr(),
                    743155724)
                assert(_mbinding != nil)
                self.interface.pointee.object_method_bind_ptrcall(
                    _mbinding,
    ...
    public func get_end_position() -> Vector2 {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            let _mbinding = self.interface.pointee.classdb_get_method_bind(
                    Self.__godot_name._native_ptr(),
                    Self._method_get_end_position_3341600327._native_ptr(),
                    3341600327)
                assert(_mbinding != nil)
                self.interface.pointee.object_method_bind_ptrcall(
                    _mbinding,
