...
public class VisualShaderNodeClamp : VisualShaderNode {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_op_type_405010749 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_op_type_405010749_name._native_ptr(), 405010749)
        ...
        self._method_get_op_type_233276050 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_op_type_233276050_name._native_ptr(), 233276050)
    ...
    public func get_op_type() -> VisualShaderNodeClamp.OpType {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return VisualShaderNodeClamp.OpType(from: __resPtr.pointee)
    }
}