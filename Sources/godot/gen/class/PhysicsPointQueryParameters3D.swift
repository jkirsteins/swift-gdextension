...
open class PhysicsPointQueryParameters3D : RefCounted {
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        self._method_set_position_3460891852 = self.interface.pointee.classdb_get_method_bind(__godot_name_PhysicsPointQueryParameters3D._native_ptr(), _method_set_position_3460891852_name._native_ptr(), 3460891852)
        ...
        self._method_get_position_3360562783 = self.interface.pointee.classdb_get_method_bind(__godot_name_PhysicsPointQueryParameters3D._native_ptr(), _method_get_position_3360562783_name._native_ptr(), 3360562783)
        ...
        self._method_set_collision_mask_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name_PhysicsPointQueryParameters3D._native_ptr(), _method_set_collision_mask_1286410249_name._native_ptr(), 1286410249)
        ...
        self._method_get_collision_mask_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name_PhysicsPointQueryParameters3D._native_ptr(), _method_get_collision_mask_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_set_exclude_381264803 = self.interface.pointee.classdb_get_method_bind(__godot_name_PhysicsPointQueryParameters3D._native_ptr(), _method_set_exclude_381264803_name._native_ptr(), 381264803)
        ...
        self._method_get_exclude_3995934104 = self.interface.pointee.classdb_get_method_bind(__godot_name_PhysicsPointQueryParameters3D._native_ptr(), _method_get_exclude_3995934104_name._native_ptr(), 3995934104)
        ...
        self._method_set_collide_with_bodies_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name_PhysicsPointQueryParameters3D._native_ptr(), _method_set_collide_with_bodies_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_is_collide_with_bodies_enabled_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name_PhysicsPointQueryParameters3D._native_ptr(), _method_is_collide_with_bodies_enabled_36873697_name._native_ptr(), 36873697)
        ...
        self._method_set_collide_with_areas_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name_PhysicsPointQueryParameters3D._native_ptr(), _method_set_collide_with_areas_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_is_collide_with_areas_enabled_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name_PhysicsPointQueryParameters3D._native_ptr(), _method_is_collide_with_areas_enabled_36873697_name._native_ptr(), 36873697)
