...
public class CurveTexture : Texture2D {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_texture_mode_1321955367 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_texture_mode_1321955367_name._native_ptr(), 1321955367)
        ...
        self._method_get_texture_mode_715756376 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_texture_mode_715756376_name._native_ptr(), 715756376)
    ...
    public func get_texture_mode() -> CurveTexture.TextureMode {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return CurveTexture.TextureMode(from: __resPtr.pointee)
    }
}