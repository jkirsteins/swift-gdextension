...
public class TCPServer : RefCounted {
    ...
    public override class func initialize_class() {
        ...
        self._method_take_connection_30545006 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_take_connection_30545006_name._native_ptr(), 30545006)
    ...
    public func take_connection() -> StreamPeerTCP {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return StreamPeerTCP(from: __resPtr.pointee)
    }
    public func stop()  {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            defer { args.deallocate() }
