...
public class InputEventJoypadButton : InputEvent {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_button_index_1466368136 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_button_index_1466368136_name._native_ptr(), 1466368136)
        ...
        self._method_get_button_index_595588182 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_button_index_595588182_name._native_ptr(), 595588182)
    ...
    public func get_button_index() -> JoyButton {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return JoyButton(from: __resPtr.pointee)
    }
