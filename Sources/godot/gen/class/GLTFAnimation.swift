...
open class GLTFAnimation : Resource {
    ...
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        ...
        self._method_get_loop_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFAnimation._native_ptr(), _method_get_loop_36873697_name._native_ptr(), 36873697)
        assert(GLTFAnimation._method_get_loop_36873697 != nil)
        let _method_set_loop_2586408642_name = StringName(from: "set_loop")
        self._method_set_loop_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name_GLTFAnimation._native_ptr(), _method_set_loop_2586408642_name._native_ptr(), 2586408642)
