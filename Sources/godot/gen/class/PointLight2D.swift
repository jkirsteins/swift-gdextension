...
open class PointLight2D : Light2D {
    ...
    static var _method_set_texture_scale_373806689: StringName! = nil
    static var _method_get_texture_scale_1740695150: StringName! = nil
    
    public override class func initialize_class(_ ginit: GodotInitializer, _ p_level: GDExtensionInitializationLevel) {
        
        guard p_level == GDEXTENSION_INITIALIZATION_SCENE else { return }

        assert(__godot_name_PointLight2D == nil)
        ...
        self._method_set_texture_scale_373806689 = StringName(from: "set_texture_scale")
        assert(self._method_set_texture_scale_373806689 != nil)
        self._method_get_texture_scale_1740695150 = StringName(from: "get_texture_scale")
        assert(self._method_get_texture_scale_1740695150 != nil)
    }
    ...
    public func set_texture_scale(texture_scale: Float64)  {
        ...
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 1)
            ...
            let _mbinding = self.interface.pointee.classdb_get_method_bind(
                    Self.__godot_name._native_ptr(),
                    Self._method_set_texture_scale_373806689._native_ptr(),
                    373806689)
                assert(_mbinding != nil)
                self.interface.pointee.object_method_bind_ptrcall(
                    _mbinding,
    ...
    public func get_texture_scale() -> Float64 {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            let _mbinding = self.interface.pointee.classdb_get_method_bind(
                    Self.__godot_name._native_ptr(),
                    Self._method_get_texture_scale_1740695150._native_ptr(),
                    1740695150)
                assert(_mbinding != nil)
                self.interface.pointee.object_method_bind_ptrcall(
                    _mbinding,
