...
public class AnimationNodeOneShot : AnimationNodeSync {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_fadein_time_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_fadein_time_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_fadein_time_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_fadein_time_1740695150_name._native_ptr(), 1740695150)
        ...
        self._method_set_fadeout_time_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_fadeout_time_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_fadeout_time_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_fadeout_time_1740695150_name._native_ptr(), 1740695150)
        ...
        self._method_set_autorestart_2586408642 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_autorestart_2586408642_name._native_ptr(), 2586408642)
        ...
        self._method_has_autorestart_36873697 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_has_autorestart_36873697_name._native_ptr(), 36873697)
        ...
        self._method_set_autorestart_delay_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_autorestart_delay_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_autorestart_delay_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_autorestart_delay_1740695150_name._native_ptr(), 1740695150)
        ...
        self._method_set_autorestart_random_delay_373806689 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_autorestart_random_delay_373806689_name._native_ptr(), 373806689)
        ...
        self._method_get_autorestart_random_delay_1740695150 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_autorestart_random_delay_1740695150_name._native_ptr(), 1740695150)
        ...
        self._method_set_mix_mode_1018899799 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_mix_mode_1018899799_name._native_ptr(), 1018899799)
        ...
        self._method_get_mix_mode_3076550526 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_mix_mode_3076550526_name._native_ptr(), 3076550526)
    ...
    public func get_mix_mode() -> AnimationNodeOneShot.MixMode {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return AnimationNodeOneShot.MixMode(from: __resPtr.pointee)
    }
}