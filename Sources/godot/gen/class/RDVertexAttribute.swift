...
/// 
/// 
public class RDVertexAttribute : RefCounted {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_location_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_location_1286410249_name._native_ptr(), 1286410249)
        ...
        self._method_get_location_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_location_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_set_offset_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_offset_1286410249_name._native_ptr(), 1286410249)
        ...
        self._method_get_offset_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_offset_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_set_stride_1286410249 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_stride_1286410249_name._native_ptr(), 1286410249)
        ...
        self._method_get_stride_3905245786 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_stride_3905245786_name._native_ptr(), 3905245786)
        ...
        self._method_set_frequency_522141836 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_frequency_522141836_name._native_ptr(), 522141836)
        ...
        self._method_get_frequency_4154106413 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_frequency_4154106413_name._native_ptr(), 4154106413)
    ...
    public func get_frequency() -> RenderingDevice.VertexFrequency {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return RenderingDevice.VertexFrequency(from: __resPtr.pointee)
    }
}