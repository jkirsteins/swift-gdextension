...
public class ResourceSaver : Object {
    ...
    public override class func initialize_class() {
        ...
        self._method_save_2303056517 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_save_2303056517_name._native_ptr(), 2303056517)
        ...
        self._method_get_recognized_extensions_4223597960 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_recognized_extensions_4223597960_name._native_ptr(), 4223597960)
        ...
        self._method_add_resource_format_saver_362894272 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_add_resource_format_saver_362894272_name._native_ptr(), 362894272)
        ...
        self._method_remove_resource_format_saver_3373026878 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_remove_resource_format_saver_3373026878_name._native_ptr(), 3373026878)
        assert(ResourceSaver._method_remove_resource_format_saver_3373026878 != nil)
    }

    public func save(resource: Resource, path: String, flags: ResourceSaver.SaverFlags) -> Error {
