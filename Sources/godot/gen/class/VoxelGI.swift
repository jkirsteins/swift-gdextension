...
public class VoxelGI : VisualInstance3D {
    ...
    public override class func initialize_class() {
        ...
        self._method_set_probe_data_1637849675 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_probe_data_1637849675_name._native_ptr(), 1637849675)
        ...
        self._method_get_probe_data_1730645405 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_probe_data_1730645405_name._native_ptr(), 1730645405)
        assert(VoxelGI._method_get_probe_data_1730645405 != nil)
        let _method_set_subdiv_2240898472_name = StringName(from: "set_subdiv")
        self._method_set_subdiv_2240898472 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_set_subdiv_2240898472_name._native_ptr(), 2240898472)
        assert(VoxelGI._method_set_subdiv_2240898472 != nil)
        let _method_get_subdiv_4261647950_name = StringName(from: "get_subdiv")
        self._method_get_subdiv_4261647950 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_get_subdiv_4261647950_name._native_ptr(), 4261647950)
        ...
        self._method_bake_2781551026 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_bake_2781551026_name._native_ptr(), 2781551026)
        assert(VoxelGI._method_bake_2781551026 != nil)
        let _method_debug_bake_3218959716_name = StringName(from: "debug_bake")
        self._method_debug_bake_3218959716 = self.interface.pointee.classdb_get_method_bind(__godot_name._native_ptr(), _method_debug_bake_3218959716_name._native_ptr(), 3218959716)
    ...
    public func get_probe_data() -> VoxelGIData {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return VoxelGIData(from: __resPtr.pointee)
    }
    ...
    public func get_subdiv() -> VoxelGI.Subdiv {
        let args: UnsafeMutableBufferPointer<GDExtensionConstTypePtr?> = .allocate(capacity: 0)
            ...
            return VoxelGI.Subdiv(from: __resPtr.pointee)
    }
